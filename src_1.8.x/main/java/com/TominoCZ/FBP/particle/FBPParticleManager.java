...
public class FBPParticleManager extends EffectRenderer {
    ...
    public FBPParticleManager(World worldIn, TextureManager rendererIn, IParticleFactory particleFactory) {
        ...
        try {
            ...
            X = lookup.unreflectGetter(ReflectionHelper.findField(Entity.class, "field_149072_b", "posX"));
            Y = lookup.unreflectGetter(ReflectionHelper.findField(Entity.class, "field_149073_c", "posY"));
            Z = lookup.unreflectGetter(ReflectionHelper.findField(Entity.class, "field_149070_d", "posZ"));
            ...
            getSourceState = lookup.unreflectGetter(
                    ReflectionHelper.findField(EntityDiggingFX.class, "field_174847_a"));
    ...
    public void addEffect(EntityFX effect) {
        ...
        if (FBP.enabled && toAdd != null && !(toAdd instanceof FBPParticleSnow)
            ...
            } else if (FBP.fancySmoke && toAdd instanceof EntitySmokeFX
