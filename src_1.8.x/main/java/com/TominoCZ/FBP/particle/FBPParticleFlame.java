...
public class FBPParticleFlame extends EntityFlameFX {
        ...
        if (!mc.isGamePaused()) {
            ...
            if (this.particleAge >= this.particleMaxAge) {
                ...
                if (particleAlpha <= 0.01)
                    ...
                    mc.effectRenderer.addEffect(new FBPParticleFlame(worldObj, startPos.xCoord, startPos.yCoord - 0.065f, startPos.zCoord,
                            0, 0, 0, spawnAnother));
                }
            }
    ...
    private void addVt(WorldRenderer worldRendererIn, double scale, Vec3 pos, double u, double v, int j, int k,
    ...
    Vec3 rotatef(Vec3 vec, float AngleX, float AngleY, float AngleZ) {
        ...
        vec = new Vec3(vec.xCoord, vec.yCoord * cosAngleX - vec.zCoord * sinAngleX, vec.yCoord * sinAngleX + vec.zCoord * cosAngleX);
        vec = new Vec3(vec.xCoord * cosAngleY + vec.zCoord * sinAngleY, vec.yCoord, vec.xCoord * sinAngleY - vec.zCoord * cosAngleY);
        vec = new Vec3(vec.xCoord * cosAngleZ - vec.yCoord * sinAngleZ, vec.xCoord * sinAngleZ + vec.yCoord * cosAngleZ, vec.zCoord);
