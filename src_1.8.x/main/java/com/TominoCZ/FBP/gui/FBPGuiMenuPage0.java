...
public class FBPGuiMenuPage0 extends GuiScreen {
    ...
    public void initGui() {
        ...
        Defaults = new FBPGuiButton(0, this.width / 2 + 2, RotSpeedSlider.yPosition + RotSpeedSlider.height + 24 - GUIOffsetY,
        ...
        Next = new FBPGuiButton(-3, RotSpeedSlider.xPosition + RotSpeedSlider.width + 25, RotSpeedSlider.yPosition + 10 - GUIOffsetY,
                ">>", false, false);
    ...
    private void drawMouseOverSelection(int mouseX, int mouseY, float partialTicks) {
        ...
        if ((mouseX >= MinDurationSlider.xPosition - 2 && mouseX <= (MinDurationSlider.xPosition + MinDurationSlider.width + 2))
                && mouseY >= MinDurationSlider.yPosition && mouseY <= (MaxDurationSlider.yPosition + MaxDurationSlider.height - 2)) {
            handle.y = MinDurationSlider.yPosition;
            size = new Vector2d(MinDurationSlider.width, 39);
            selected = 1;
        } else if (((mouseX >= ParticleCountBase.xPosition) && (mouseX <= ParticleCountBase.xPosition + ParticleCountBase.width))
            ...
            selected = 2;
        } else if (((mouseX >= ScaleMultSlider.xPosition) && (mouseX <= ScaleMultSlider.xPosition + ScaleMultSlider.width))
            ...
            selected = 3;
        } else if (((mouseX >= GravitiyForceSlider.xPosition) && (mouseX <= GravitiyForceSlider.xPosition + GravitiyForceSlider.width))
            ...
            selected = 4;
                ...
                && (mouseY >= RotSpeedSlider.yPosition + 1) && (mouseY <= RotSpeedSlider.yPosition + RotSpeedSlider.height - 1)) {
        ...
        if (((mouseX >= MinDurationSlider.xPosition - 2 && mouseX <= MinDurationSlider.xPosition + MinDurationSlider.width + 2)
                ...
                && (lastSize.y <= 20 || (lastSize.y < 50 && lastSize.y > 20)) && lastHandle.y >= MinDurationSlider.yPosition)
