...
public class FBPGuiMenuPage2 extends GuiScreen {
    ...
    public void initGui() {
        ...
        Defaults = new FBPGuiButton(0, this.width / 2 + 2, b6.yPosition + b6.height + 24 - GUIOffsetY, "Defaults", false,
                false);
        Done = new FBPGuiButton(-1, this.width / 2 - 100, Defaults.yPosition, "Done", false, false);
        Reload = new FBPGuiButton(-2, this.width / 2 - 100, Defaults.yPosition + Defaults.height + 1, "Reload Config", false,
                false);
