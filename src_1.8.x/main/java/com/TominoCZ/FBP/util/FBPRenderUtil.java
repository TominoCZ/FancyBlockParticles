...
public class FBPRenderUtil {
	public static void renderCubeShaded_S(WorldRenderer buf, Vec2f[] par, float f5, float f6, float f7, double scale,
	...
	public static void renderCubeShaded_WH(WorldRenderer buf, Vec2f[] par, float f5, float f6, float f7, double width,
										   double height, FBPVector3d rotVec, int j, int k, float r, float g, float b, float a) {
		buf.setTranslation(f5, f6, f7);
	...
	static void putCube_S(WorldRenderer worldRendererIn, Vec2f[] par, double scale, FBPVector3d rotVec, int j, int k,
	...
	static void putCube_WH(WorldRenderer worldRendererIn, Vec2f[] par, double width, double height, FBPVector3d rotVec,
	...
	static void addVt_S(WorldRenderer worldRendererIn, double scale, Vec3 pos, double u, double v, int j, int k,
		...
		worldRendererIn.pos(pos.xCoord * scale, pos.yCoord * scale, pos.zCoord * scale).tex(u, v).color(r, g, b, a).lightmap(j, k)
				.normal((float) n.xCoord, (float) n.yCoord, (float) n.zCoord).endVertex();
	}
