...
public class FBPKeyBindings {
	public static KeyBinding FBPMenu, FBPFreeze, FBPToggle, FBPSweep, FBPQuickAdd;
	...
	public static void init() {
		...
		FBPQuickAdd = new KeyBinding("Blacklist Block", Keyboard.KEY_X, "Fancy Block Particles");
		...
		ClientRegistry.registerKeyBinding(FBPQuickAdd);
	}
}