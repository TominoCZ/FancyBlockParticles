...
public class FBPRenderBlocks extends RenderBlocks {

	ConcurrentHashMap<FBPBlockPos, Integer> metaTags = new ConcurrentHashMap<FBPBlockPos, Integer>();

	public FBPRenderBlocks(IBlockAccess access) {
		super(access);
	}
	@Override
	/**
	...
	public boolean renderBlockByRenderType(Block p_147805_1_, int p_147805_2_, int p_147805_3_, int p_147805_4_,
			int meta) {
		FBPBlockPos pos = new FBPBlockPos(p_147805_2_, p_147805_3_, p_147805_4_);
		...
		if (l == -1) {
			...
			case 40:
				return this.renderBlockDoublePlant((BlockDoublePlant) p_147805_1_, p_147805_2_, p_147805_3_,
						p_147805_4_);
			case 2:
			...
			case 9:
				return this.renderBlockMinecartTrack((BlockRailBase) p_147805_1_, p_147805_2_, p_147805_3_,
						p_147805_4_);
			case 19:
			...
			case 27:
				return this.renderBlockDragonEgg((BlockDragonEgg) p_147805_1_, p_147805_2_, p_147805_3_, p_147805_4_);
			case 32:
			...
			case 15:
				return this.renderBlockRepeater((BlockRedstoneRepeater) p_147805_1_, p_147805_2_, p_147805_3_,
						p_147805_4_);
			case 36:
				return this.renderBlockRedstoneDiode((BlockRedstoneDiode) p_147805_1_, p_147805_2_, p_147805_3_,
						p_147805_4_);
			case 37:
				return this.renderBlockRedstoneComparator((BlockRedstoneComparator) p_147805_1_, p_147805_2_,
						p_147805_3_, p_147805_4_);
			case 16:
			...
			case 21:
				return this.renderBlockFenceGate((BlockFenceGate) p_147805_1_, p_147805_2_, p_147805_3_, p_147805_4_);
			case 24:
				return this.renderBlockCauldron((BlockCauldron) p_147805_1_, p_147805_2_, p_147805_3_, p_147805_4_);
			case 33:
				return this.renderBlockFlowerpot((BlockFlowerPot) p_147805_1_, p_147805_2_, p_147805_3_, p_147805_4_);
			case 35:
				return this.renderBlockAnvil((BlockAnvil) p_147805_1_, p_147805_2_, p_147805_3_, p_147805_4_);
			case 25:
				return this.renderBlockBrewingStand((BlockBrewingStand) p_147805_1_, p_147805_2_, p_147805_3_,
						p_147805_4_);
			case 26:
				return this.renderBlockEndPortalFrame((BlockEndPortalFrame) p_147805_1_, p_147805_2_, p_147805_3_,
						p_147805_4_);
			case 28:
	...
	public boolean renderBlockEndPortalFrame(BlockEndPortalFrame p_147743_1_, int p_147743_2_, int p_147743_3_,
			int p_147743_4_) {
		int l = this.getMeta(p_147743_2_, p_147743_3_, p_147743_4_);
		int i1 = l & 3;
	...
	public boolean renderBlockBed(Block p_147773_1_, int p_147773_2_, int p_147773_3_, int p_147773_4_) {
		...
		tessellator.setBrightness(
				p_147773_1_.getMixedBrightnessForBlock(this.blockAccess, p_147773_2_, p_147773_3_ + 1, p_147773_4_));
		...
		if (k1 != 2 && (this.renderAllFaces
				|| p_147773_1_.shouldSideBeRendered(this.blockAccess, p_147773_2_, p_147773_3_, p_147773_4_ - 1, 2))) {
			tessellator.setBrightness(this.renderMinZ > 0.0D ? j1
					: p_147773_1_.getMixedBrightnessForBlock(this.blockAccess, p_147773_2_, p_147773_3_,
							p_147773_4_ - 1));
		...
		if (k1 != 4 && (this.renderAllFaces
				|| p_147773_1_.shouldSideBeRendered(this.blockAccess, p_147773_2_ - 1, p_147773_3_, p_147773_4_, 4))) {
			tessellator.setBrightness(this.renderMinZ > 0.0D ? j1
					: p_147773_1_.getMixedBrightnessForBlock(this.blockAccess, p_147773_2_ - 1, p_147773_3_,
							p_147773_4_));
	...
	public boolean renderBlockBrewingStand(BlockBrewingStand p_147741_1_, int p_147741_2_, int p_147741_3_,
		...
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147741_1_.getMixedBrightnessForBlock(this.blockAccess, p_147741_2_, p_147741_3_, p_147741_4_));
		...
		int i1 = this.getMeta(p_147741_2_, p_147741_3_, p_147741_4_);
	...
	public boolean renderBlockCauldron(BlockCauldron p_147785_1_, int p_147785_2_, int p_147785_3_, int p_147785_4_) {
		...
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147785_1_.getMixedBrightnessForBlock(this.blockAccess, p_147785_2_, p_147785_3_, p_147785_4_));
		...
		f4 = 0.125F;
		this.renderFaceXPos(p_147785_1_, (double) ((float) p_147785_2_ - 1.0F + f4), (double) p_147785_3_,
				(double) p_147785_4_, iicon1);
		this.renderFaceXNeg(p_147785_1_, (double) ((float) p_147785_2_ + 1.0F - f4), (double) p_147785_3_,
				(double) p_147785_4_, iicon1);
		this.renderFaceZPos(p_147785_1_, (double) p_147785_2_, (double) p_147785_3_,
				(double) ((float) p_147785_4_ - 1.0F + f4), iicon1);
	...
	public boolean renderBlockFlowerpot(BlockFlowerPot p_147752_1_, int p_147752_2_, int p_147752_3_, int p_147752_4_) {
		...
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147752_1_.getMixedBrightnessForBlock(this.blockAccess, p_147752_2_, p_147752_3_, p_147752_4_));
		...
		tessellator.setColorOpaque_F(f, f1, f2);
		f3 = 0.1865F;
		this.renderFaceXPos(p_147752_1_, (double) ((float) p_147752_2_ - 0.5F + f3), (double) p_147752_3_,
				(double) p_147752_4_, iicon);
		this.renderFaceXNeg(p_147752_1_, (double) ((float) p_147752_2_ + 0.5F - f3), (double) p_147752_3_,
				(double) p_147752_4_, iicon);
		this.renderFaceZPos(p_147752_1_, (double) p_147752_2_, (double) p_147752_3_,
				(double) ((float) p_147752_4_ - 0.5F + f3), iicon);
		this.renderFaceZNeg(p_147752_1_, (double) p_147752_2_, (double) p_147752_3_,
				(double) ((float) p_147752_4_ + 0.5F - f3), iicon);
		this.renderFaceYPos(p_147752_1_, (double) p_147752_2_, (double) ((float) p_147752_3_ - 0.5F + f3 + 0.1875F),
		...
		if (tileentity != null && tileentity instanceof TileEntityFlowerPot) {
			...
			if (item instanceof ItemBlock) {
				...
				if (j1 == 1) {
					this.drawCrossedSquares(this.getBlockIconFromSideAndMetadata(block, 0, i1), (double) p_147752_2_,
							(double) p_147752_3_, (double) p_147752_4_, 0.75F);
				} else if (j1 == 13) {
					this.renderAllFaces = true;
					float f9 = 0.125F;
					this.setRenderBounds((double) (0.5F - f9), 0.0D, (double) (0.5F - f9), (double) (0.5F + f9), 0.25D,
							(double) (0.5F + f9));
					this.renderStandardBlock(block, p_147752_2_, p_147752_3_, p_147752_4_);
					this.setRenderBounds((double) (0.5F - f9), 0.25D, (double) (0.5F - f9), (double) (0.5F + f9), 0.5D,
							(double) (0.5F + f9));
					this.renderStandardBlock(block, p_147752_2_, p_147752_3_, p_147752_4_);
					this.setRenderBounds((double) (0.5F - f9), 0.5D, (double) (0.5F - f9), (double) (0.5F + f9), 0.75D,
							(double) (0.5F + f9));
					this.renderStandardBlock(block, p_147752_2_, p_147752_3_, p_147752_4_);
					this.renderAllFaces = false;
	...
	public boolean renderBlockAnvil(BlockAnvil p_147725_1_, int p_147725_2_, int p_147725_3_, int p_147725_4_) {
		return this.renderBlockAnvilMetadata(p_147725_1_, p_147725_2_, p_147725_3_, p_147725_4_,
				this.getMeta(p_147725_2_, p_147725_3_, p_147725_4_));
	}
	@Override
	/**
	...
	public boolean renderBlockAnvilMetadata(BlockAnvil p_147780_1_, int p_147780_2_, int p_147780_3_, int p_147780_4_,
		...
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147780_1_.getMixedBrightnessForBlock(this.blockAccess, p_147780_2_, p_147780_3_, p_147780_4_));
	...
	public boolean renderBlockAnvilOrient(BlockAnvil p_147728_1_, int p_147728_2_, int p_147728_3_, int p_147728_4_,
		...
		f = this.renderBlockAnvilRotate(p_147728_1_, p_147728_2_, p_147728_3_, p_147728_4_, 0, f, 0.75F, 0.25F, 0.75F,
				flag1, p_147728_6_, p_147728_5_);
		f = this.renderBlockAnvilRotate(p_147728_1_, p_147728_2_, p_147728_3_, p_147728_4_, 1, f, 0.5F, 0.0625F, 0.625F,
				flag1, p_147728_6_, p_147728_5_);
		f = this.renderBlockAnvilRotate(p_147728_1_, p_147728_2_, p_147728_3_, p_147728_4_, 2, f, 0.25F, 0.3125F, 0.5F,
				flag1, p_147728_6_, p_147728_5_);
		this.renderBlockAnvilRotate(p_147728_1_, p_147728_2_, p_147728_3_, p_147728_4_, 3, f, 0.625F, 0.375F, 1.0F,
				flag1, p_147728_6_, p_147728_5_);
		this.setRenderBounds(0.0D, 0.0D, 0.0D, 1.0D, 1.0D, 1.0D);
		this.uvRotateEast = 0;
		this.uvRotateWest = 0;
	...
	public boolean renderBlockTorch(Block p_147791_1_, int p_147791_2_, int p_147791_3_, int p_147791_4_) {
		int l = this.getMeta(p_147791_2_, p_147791_3_, p_147791_4_);
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147791_1_.getMixedBrightnessForBlock(this.blockAccess, p_147791_2_, p_147791_3_, p_147791_4_));
		...
		if (l == 1) {
			this.renderTorchAtAngle(p_147791_1_, (double) p_147791_2_ - d1, (double) p_147791_3_ + d2,
					(double) p_147791_4_, -d0, 0.0D, 0);
		} else if (l == 2) {
			this.renderTorchAtAngle(p_147791_1_, (double) p_147791_2_ + d1, (double) p_147791_3_ + d2,
					(double) p_147791_4_, d0, 0.0D, 0);
		} else if (l == 3) {
			this.renderTorchAtAngle(p_147791_1_, (double) p_147791_2_, (double) p_147791_3_ + d2,
					(double) p_147791_4_ - d1, 0.0D, -d0, 0);
		} else if (l == 4) {
			this.renderTorchAtAngle(p_147791_1_, (double) p_147791_2_, (double) p_147791_3_ + d2,
					(double) p_147791_4_ + d1, 0.0D, d0, 0);
		} else {
	...
	public boolean renderBlockRepeater(BlockRedstoneRepeater p_147759_1_, int p_147759_2_, int p_147759_3_,
			int p_147759_4_) {
		int l = this.getMeta(p_147759_2_, p_147759_3_, p_147759_4_);
		int i1 = l & 3;
		int j1 = (l & 12) >> 2;
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147759_1_.getMixedBrightnessForBlock(this.blockAccess, p_147759_2_, p_147759_3_, p_147759_4_));
		tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
		double d0 = -0.1875D;
		...
		if (!flag) {
			this.renderTorchAtAngle(p_147759_1_, (double) p_147759_2_ + d1, (double) p_147759_3_ + d0,
					(double) p_147759_4_ + d2, 0.0D, 0.0D, 0);
		} else {
			...
			case 2:
			default:
				this.setRenderBounds((double) (f / 16.0F + (float) d1), 0.125D, (double) (f2 / 16.0F + (float) d2),
				...
				tessellator.addVertexWithUV((double) ((float) p_147759_2_ + f / 16.0F) + d1,
						(double) ((float) p_147759_3_ + 0.25F), (double) ((float) p_147759_4_ + f2 / 16.0F) + d2, d5,
						d6);
				tessellator.addVertexWithUV((double) ((float) p_147759_2_ + f / 16.0F) + d1,
						(double) ((float) p_147759_3_ + 0.25F), (double) ((float) p_147759_4_ + f3 / 16.0F) + d2, d5,
						d8);
				tessellator.addVertexWithUV((double) ((float) p_147759_2_ + f1 / 16.0F) + d1,
						(double) ((float) p_147759_3_ + 0.25F), (double) ((float) p_147759_4_ + f3 / 16.0F) + d2, d7,
						d8);
				tessellator.addVertexWithUV((double) ((float) p_147759_2_ + f1 / 16.0F) + d1,
						(double) ((float) p_147759_3_ + 0.25F), (double) ((float) p_147759_4_ + f2 / 16.0F) + d2, d7,
						d6);
		...
		tessellator.setBrightness(
				p_147759_1_.getMixedBrightnessForBlock(this.blockAccess, p_147759_2_, p_147759_3_, p_147759_4_));
		tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
		this.renderTorchAtAngle(p_147759_1_, (double) p_147759_2_ + d3, (double) p_147759_3_ + d0,
				(double) p_147759_4_ + d4, 0.0D, 0.0D, 0);
	...
	public boolean renderBlockRedstoneComparator(BlockRedstoneComparator p_147781_1_, int p_147781_2_, int p_147781_3_,
		...
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147781_1_.getMixedBrightnessForBlock(this.blockAccess, p_147781_2_, p_147781_3_, p_147781_4_));
		tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
		int l = this.getMeta(p_147781_2_, p_147781_3_, p_147781_4_);
		int i1 = l & 3;
		double d0 = 0.0D;
		double d1 = -0.1875D;
		double d2 = 0.0D;
		...
		this.renderTorchAtAngle(p_147781_1_, (double) p_147781_2_ + 0.25D * d3 + 0.1875D * d4,
				(double) ((float) p_147781_3_ - 0.1875F), (double) p_147781_4_ + 0.25D * d4 + 0.1875D * d3, 0.0D, 0.0D,
				l);
		this.renderTorchAtAngle(p_147781_1_, (double) p_147781_2_ + 0.25D * d3 + -0.1875D * d4,
				(double) ((float) p_147781_3_ - 0.1875F), (double) p_147781_4_ + 0.25D * d4 + -0.1875D * d3, 0.0D, 0.0D,
				l);
		this.setOverrideBlockTexture(iicon);
		this.renderTorchAtAngle(p_147781_1_, (double) p_147781_2_ + d0, (double) p_147781_3_ + d1,
				(double) p_147781_4_ + d2, 0.0D, 0.0D, l);
		this.clearOverrideBlockTexture();
	...
	public boolean renderBlockRedstoneDiode(BlockRedstoneDiode p_147748_1_, int p_147748_2_, int p_147748_3_,
		...
		this.renderBlockRedstoneDiodeMetadata(p_147748_1_, p_147748_2_, p_147748_3_, p_147748_4_,
				this.getMeta(p_147748_2_, p_147748_3_, p_147748_4_) & 3);
		return true;
	}
	@Override
	public void renderBlockRedstoneDiodeMetadata(BlockRedstoneDiode p_147732_1_, int p_147732_2_, int p_147732_3_,
		...
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147732_1_.getMixedBrightnessForBlock(this.blockAccess, p_147732_2_, p_147732_3_, p_147732_4_));
		tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
		int i1 = this.getMeta(p_147732_2_, p_147732_3_, p_147732_4_);
	...
	public boolean renderPistonBase(Block p_147731_1_, int p_147731_2_, int p_147731_3_, int p_147731_4_,
			boolean p_147731_5_) {
		int l = this.getMeta(p_147731_2_, p_147731_3_, p_147731_4_);
	...
	public boolean renderPistonExtension(Block p_147809_1_, int p_147809_2_, int p_147809_3_, int p_147809_4_,
			boolean p_147809_5_) {
		int l = this.getMeta(p_147809_2_, p_147809_3_, p_147809_4_);
		...
		case 0:
			...
			this.renderPistonRodUD((double) ((float) p_147809_2_ + 0.375F), (double) ((float) p_147809_2_ + 0.625F),
					(double) ((float) p_147809_3_ + 0.25F), (double) ((float) p_147809_3_ + 0.25F + f3),
					(double) ((float) p_147809_4_ + 0.625F), (double) ((float) p_147809_4_ + 0.625F), 0.8F, d0);
			this.renderPistonRodUD((double) ((float) p_147809_2_ + 0.625F), (double) ((float) p_147809_2_ + 0.375F),
					(double) ((float) p_147809_3_ + 0.25F), (double) ((float) p_147809_3_ + 0.25F + f3),
					(double) ((float) p_147809_4_ + 0.375F), (double) ((float) p_147809_4_ + 0.375F), 0.8F, d0);
			this.renderPistonRodUD((double) ((float) p_147809_2_ + 0.375F), (double) ((float) p_147809_2_ + 0.375F),
					(double) ((float) p_147809_3_ + 0.25F), (double) ((float) p_147809_3_ + 0.25F + f3),
					(double) ((float) p_147809_4_ + 0.375F), (double) ((float) p_147809_4_ + 0.625F), 0.6F, d0);
			this.renderPistonRodUD((double) ((float) p_147809_2_ + 0.625F), (double) ((float) p_147809_2_ + 0.625F),
					(double) ((float) p_147809_3_ + 0.25F), (double) ((float) p_147809_3_ + 0.25F + f3),
					(double) ((float) p_147809_4_ + 0.625F), (double) ((float) p_147809_4_ + 0.375F), 0.6F, d0);
			break;
		case 1:
			this.setRenderBounds(0.0D, 0.75D, 0.0D, 1.0D, 1.0D, 1.0D);
			this.renderStandardBlock(p_147809_1_, p_147809_2_, p_147809_3_, p_147809_4_);
			this.renderPistonRodUD((double) ((float) p_147809_2_ + 0.375F), (double) ((float) p_147809_2_ + 0.625F),
					(double) ((float) p_147809_3_ - 0.25F + 1.0F - f3), (double) ((float) p_147809_3_ - 0.25F + 1.0F),
					(double) ((float) p_147809_4_ + 0.625F), (double) ((float) p_147809_4_ + 0.625F), 0.8F, d0);
			this.renderPistonRodUD((double) ((float) p_147809_2_ + 0.625F), (double) ((float) p_147809_2_ + 0.375F),
					(double) ((float) p_147809_3_ - 0.25F + 1.0F - f3), (double) ((float) p_147809_3_ - 0.25F + 1.0F),
					(double) ((float) p_147809_4_ + 0.375F), (double) ((float) p_147809_4_ + 0.375F), 0.8F, d0);
		...
		case 2:
			...
			this.renderPistonRodSN((double) ((float) p_147809_2_ + 0.375F), (double) ((float) p_147809_2_ + 0.375F),
					...
					(double) ((float) p_147809_4_ + 0.25F), (double) ((float) p_147809_4_ + 0.25F + f3), 0.6F, d0);
			...
			this.renderPistonRodSN((double) ((float) p_147809_2_ + 0.375F), (double) ((float) p_147809_2_ + 0.625F),
					...
					(double) ((float) p_147809_4_ + 0.25F), (double) ((float) p_147809_4_ + 0.25F + f3), 0.5F, d0);
			this.renderPistonRodSN((double) ((float) p_147809_2_ + 0.625F), (double) ((float) p_147809_2_ + 0.375F),
					...
					(double) ((float) p_147809_4_ + 0.25F), (double) ((float) p_147809_4_ + 0.25F + f3), 1.0F, d0);
			break;
		case 3:
			this.uvRotateSouth = 2;
			this.uvRotateNorth = 1;
			...
			this.renderPistonRodSN((double) ((float) p_147809_2_ + 0.375F), (double) ((float) p_147809_2_ + 0.375F),
					(double) ((float) p_147809_3_ + 0.625F), (double) ((float) p_147809_3_ + 0.375F),
					(double) ((float) p_147809_4_ - 0.25F + 1.0F - f3), (double) ((float) p_147809_4_ - 0.25F + 1.0F),
					0.6F, d0);
			this.renderPistonRodSN((double) ((float) p_147809_2_ + 0.625F), (double) ((float) p_147809_2_ + 0.625F),
					(double) ((float) p_147809_3_ + 0.375F), (double) ((float) p_147809_3_ + 0.625F),
					(double) ((float) p_147809_4_ - 0.25F + 1.0F - f3), (double) ((float) p_147809_4_ - 0.25F + 1.0F),
		...
		case 4:
			...
			this.renderStandardBlock(p_147809_1_, p_147809_2_, p_147809_3_, p_147809_4_);
			this.renderPistonRodEW((double) ((float) p_147809_2_ + 0.25F), (double) ((float) p_147809_2_ + 0.25F + f3),
					(double) ((float) p_147809_3_ + 0.375F), (double) ((float) p_147809_3_ + 0.375F),
					(double) ((float) p_147809_4_ + 0.625F), (double) ((float) p_147809_4_ + 0.375F), 0.5F, d0);
			this.renderPistonRodEW((double) ((float) p_147809_2_ + 0.25F), (double) ((float) p_147809_2_ + 0.25F + f3),
					(double) ((float) p_147809_3_ + 0.625F), (double) ((float) p_147809_3_ + 0.625F),
					(double) ((float) p_147809_4_ + 0.375F), (double) ((float) p_147809_4_ + 0.625F), 1.0F, d0);
			this.renderPistonRodEW((double) ((float) p_147809_2_ + 0.25F), (double) ((float) p_147809_2_ + 0.25F + f3),
					(double) ((float) p_147809_3_ + 0.375F), (double) ((float) p_147809_3_ + 0.625F),
					(double) ((float) p_147809_4_ + 0.375F), (double) ((float) p_147809_4_ + 0.375F), 0.6F, d0);
			this.renderPistonRodEW((double) ((float) p_147809_2_ + 0.25F), (double) ((float) p_147809_2_ + 0.25F + f3),
					(double) ((float) p_147809_3_ + 0.625F), (double) ((float) p_147809_3_ + 0.375F),
					(double) ((float) p_147809_4_ + 0.625F), (double) ((float) p_147809_4_ + 0.625F), 0.6F, d0);
			break;
		case 5:
			this.uvRotateEast = 2;
			this.uvRotateWest = 1;
			...
			this.renderStandardBlock(p_147809_1_, p_147809_2_, p_147809_3_, p_147809_4_);
			this.renderPistonRodEW((double) ((float) p_147809_2_ - 0.25F + 1.0F - f3),
					...
					(double) ((float) p_147809_4_ + 0.375F), 0.5F, d0);
			this.renderPistonRodEW((double) ((float) p_147809_2_ - 0.25F + 1.0F - f3),
					...
					(double) ((float) p_147809_4_ + 0.625F), 1.0F, d0);
			this.renderPistonRodEW((double) ((float) p_147809_2_ - 0.25F + 1.0F - f3),
					(double) ((float) p_147809_2_ - 0.25F + 1.0F), (double) ((float) p_147809_3_ + 0.375F),
					(double) ((float) p_147809_3_ + 0.625F), (double) ((float) p_147809_4_ + 0.375F),
					(double) ((float) p_147809_4_ + 0.375F), 0.6F, d0);
			this.renderPistonRodEW((double) ((float) p_147809_2_ - 0.25F + 1.0F - f3),
					(double) ((float) p_147809_2_ - 0.25F + 1.0F), (double) ((float) p_147809_3_ + 0.625F),
					(double) ((float) p_147809_3_ + 0.375F), (double) ((float) p_147809_4_ + 0.625F),
					(double) ((float) p_147809_4_ + 0.625F), 0.6F, d0);
		}
	...
	public boolean renderBlockLever(Block p_147790_1_, int p_147790_2_, int p_147790_3_, int p_147790_4_) {
		int l = this.getMeta(p_147790_2_, p_147790_3_, p_147790_4_);
		int i1 = l & 7;
		boolean flag = (l & 8) > 0;
		Tessellator tessellator = Tessellator.instance;
		...
		if (i1 == 5) {
			this.setRenderBounds((double) (0.5F - f1), 0.0D, (double) (0.5F - f), (double) (0.5F + f1), (double) f2,
					(double) (0.5F + f));
		} else if (i1 == 6) {
			this.setRenderBounds((double) (0.5F - f), 0.0D, (double) (0.5F - f1), (double) (0.5F + f), (double) f2,
					(double) (0.5F + f1));
		} else if (i1 == 4) {
			this.setRenderBounds((double) (0.5F - f1), (double) (0.5F - f), (double) (1.0F - f2), (double) (0.5F + f1),
					(double) (0.5F + f), 1.0D);
		} else if (i1 == 3) {
			this.setRenderBounds((double) (0.5F - f1), (double) (0.5F - f), 0.0D, (double) (0.5F + f1),
					(double) (0.5F + f), (double) f2);
		} else if (i1 == 2) {
			this.setRenderBounds((double) (1.0F - f2), (double) (0.5F - f), (double) (0.5F - f1), 1.0D,
					(double) (0.5F + f), (double) (0.5F + f1));
		} else if (i1 == 1) {
			this.setRenderBounds(0.0D, (double) (0.5F - f), (double) (0.5F - f1), (double) f2, (double) (0.5F + f),
					(double) (0.5F + f1));
		} else if (i1 == 0) {
			this.setRenderBounds((double) (0.5F - f), (double) (1.0F - f2), (double) (0.5F - f1), (double) (0.5F + f),
					1.0D, (double) (0.5F + f1));
		} else if (i1 == 7) {
			this.setRenderBounds((double) (0.5F - f1), (double) (1.0F - f2), (double) (0.5F - f), (double) (0.5F + f1),
					1.0D, (double) (0.5F + f));
		}
		...
		tessellator.setBrightness(
				p_147790_1_.getMixedBrightnessForBlock(this.blockAccess, p_147790_2_, p_147790_3_, p_147790_4_));
		tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
	...
	public boolean renderBlockTripWireSource(Block p_147723_1_, int p_147723_2_, int p_147723_3_, int p_147723_4_) {
		Tessellator tessellator = Tessellator.instance;
		int l = this.getMeta(p_147723_2_, p_147723_3_, p_147723_4_);
		int i1 = l & 3;
		boolean flag = (l & 4) == 4;
		boolean flag1 = (l & 8) == 8;
		boolean flag2 = !World.doesBlockHaveSolidTopSurface(this.blockAccess, p_147723_2_, p_147723_3_ - 1,
				p_147723_4_);
		...
		if (i1 == 2) {
			this.setRenderBounds((double) (0.5F - f1), (double) f3, (double) (1.0F - f2), (double) (0.5F + f1),
					(double) f4, 1.0D);
		} else if (i1 == 0) {
			this.setRenderBounds((double) (0.5F - f1), (double) f3, 0.0D, (double) (0.5F + f1), (double) f4,
					(double) f2);
		} else if (i1 == 1) {
			this.setRenderBounds((double) (1.0F - f2), (double) f3, (double) (0.5F - f1), 1.0D, (double) f4,
					(double) (0.5F + f1));
		} else if (i1 == 3) {
			this.setRenderBounds(0.0D, (double) f3, (double) (0.5F - f1), (double) f2, (double) f4,
					(double) (0.5F + f1));
		}
		...
		tessellator.setBrightness(
				p_147723_1_.getMixedBrightnessForBlock(this.blockAccess, p_147723_2_, p_147723_3_, p_147723_4_));
		tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
		...
		if (flag) {
			...
			if (i1 == 2) {
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f11), (double) p_147723_3_ + d8,
						(double) p_147723_4_ + 0.25D, d4, d5);
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f12), (double) p_147723_3_ + d8,
						(double) p_147723_4_ + 0.25D, d4, d7);
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f12), (double) p_147723_3_ + d8,
						(double) p_147723_4_, d6, d7);
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f11), (double) p_147723_3_ + d8,
						(double) p_147723_4_, d6, d5);
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f11), d9, (double) p_147723_4_ + 0.5D, d4,
						d5);
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f12), d9, (double) p_147723_4_ + 0.5D, d4,
						d7);
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f12), (double) p_147723_3_ + d8,
						(double) p_147723_4_ + 0.25D, d6, d7);
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f11), (double) p_147723_3_ + d8,
						(double) p_147723_4_ + 0.25D, d6, d5);
			} else if (i1 == 0) {
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f11), (double) p_147723_3_ + d8,
						(double) p_147723_4_ + 0.75D, d4, d5);
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f12), (double) p_147723_3_ + d8,
						(double) p_147723_4_ + 0.75D, d4, d7);
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f12), d9, (double) p_147723_4_ + 0.5D, d6,
						d7);
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f11), d9, (double) p_147723_4_ + 0.5D, d6,
						d5);
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f11), (double) p_147723_3_ + d8,
						(double) (p_147723_4_ + 1), d4, d5);
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f12), (double) p_147723_3_ + d8,
						(double) (p_147723_4_ + 1), d4, d7);
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f12), (double) p_147723_3_ + d8,
						(double) p_147723_4_ + 0.75D, d6, d7);
				tessellator.addVertexWithUV((double) ((float) p_147723_2_ + f11), (double) p_147723_3_ + d8,
						(double) p_147723_4_ + 0.75D, d6, d5);
			} else if (i1 == 1) {
				tessellator.addVertexWithUV((double) p_147723_2_, (double) p_147723_3_ + d8,
						(double) ((float) p_147723_4_ + f12), d4, d7);
				tessellator.addVertexWithUV((double) p_147723_2_ + 0.25D, (double) p_147723_3_ + d8,
						(double) ((float) p_147723_4_ + f12), d6, d7);
				tessellator.addVertexWithUV((double) p_147723_2_ + 0.25D, (double) p_147723_3_ + d8,
						(double) ((float) p_147723_4_ + f11), d6, d5);
				tessellator.addVertexWithUV((double) p_147723_2_, (double) p_147723_3_ + d8,
						(double) ((float) p_147723_4_ + f11), d4, d5);
				tessellator.addVertexWithUV((double) p_147723_2_ + 0.25D, (double) p_147723_3_ + d8,
						(double) ((float) p_147723_4_ + f12), d4, d7);
				tessellator.addVertexWithUV((double) p_147723_2_ + 0.5D, d9, (double) ((float) p_147723_4_ + f12), d6,
						d7);
				tessellator.addVertexWithUV((double) p_147723_2_ + 0.5D, d9, (double) ((float) p_147723_4_ + f11), d6,
						d5);
				tessellator.addVertexWithUV((double) p_147723_2_ + 0.25D, (double) p_147723_3_ + d8,
						(double) ((float) p_147723_4_ + f11), d4, d5);
			} else {
				tessellator.addVertexWithUV((double) p_147723_2_ + 0.5D, d9, (double) ((float) p_147723_4_ + f12), d4,
						d7);
				tessellator.addVertexWithUV((double) p_147723_2_ + 0.75D, (double) p_147723_3_ + d8,
						(double) ((float) p_147723_4_ + f12), d6, d7);
				tessellator.addVertexWithUV((double) p_147723_2_ + 0.75D, (double) p_147723_3_ + d8,
						(double) ((float) p_147723_4_ + f11), d6, d5);
				tessellator.addVertexWithUV((double) p_147723_2_ + 0.5D, d9, (double) ((float) p_147723_4_ + f11), d4,
						d5);
				tessellator.addVertexWithUV((double) p_147723_2_ + 0.75D, (double) p_147723_3_ + d8,
						(double) ((float) p_147723_4_ + f12), d4, d7);
				tessellator.addVertexWithUV((double) (p_147723_2_ + 1), (double) p_147723_3_ + d8,
						(double) ((float) p_147723_4_ + f12), d6, d7);
				tessellator.addVertexWithUV((double) (p_147723_2_ + 1), (double) p_147723_3_ + d8,
						(double) ((float) p_147723_4_ + f11), d6, d5);
				tessellator.addVertexWithUV((double) p_147723_2_ + 0.75D, (double) p_147723_3_ + d8,
	...
	public boolean renderBlockTripWire(Block p_147756_1_, int p_147756_2_, int p_147756_3_, int p_147756_4_) {
		...
		int l = this.getMeta(p_147756_2_, p_147756_3_, p_147756_4_);
		boolean flag = (l & 4) == 4;
		boolean flag1 = (l & 2) == 2;
		...
		tessellator.setBrightness(
				p_147756_1_.getMixedBrightnessForBlock(this.blockAccess, p_147756_2_, p_147756_3_, p_147756_4_));
		tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
		double d0 = (double) iicon.getMinU();
		...
		if (flag4) {
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f1), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.25D, d0, d1);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f2), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.25D, d0, d3);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f2), (double) p_147756_3_ + d4,
					(double) p_147756_4_, d2, d3);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f1), (double) p_147756_3_ + d4,
					(double) p_147756_4_, d2, d1);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f1), (double) p_147756_3_ + d4,
					(double) p_147756_4_, d2, d1);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f2), (double) p_147756_3_ + d4,
					(double) p_147756_4_, d2, d3);
		...
		if (flag4 || flag5 && !flag3 && !flag2) {
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f1), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.5D, d0, d1);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f2), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.5D, d0, d3);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f2), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.25D, d2, d3);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f1), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.25D, d2, d1);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f1), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.25D, d2, d1);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f2), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.25D, d2, d3);
		...
		if (flag5 || flag4 && !flag3 && !flag2) {
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f1), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.75D, d0, d1);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f2), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.75D, d0, d3);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f2), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.5D, d2, d3);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f1), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.5D, d2, d1);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f1), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.5D, d2, d1);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f2), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.5D, d2, d3);
		...
		if (flag5) {
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f1), (double) p_147756_3_ + d4,
					(double) (p_147756_4_ + 1), d0, d1);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f2), (double) p_147756_3_ + d4,
					(double) (p_147756_4_ + 1), d0, d3);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f2), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.75D, d2, d3);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f1), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.75D, d2, d1);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f1), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.75D, d2, d1);
			tessellator.addVertexWithUV((double) ((float) p_147756_2_ + f2), (double) p_147756_3_ + d4,
					(double) p_147756_4_ + 0.75D, d2, d3);
		...
		if (flag2) {
			tessellator.addVertexWithUV((double) p_147756_2_, (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f2), d0, d3);
			tessellator.addVertexWithUV((double) p_147756_2_ + 0.25D, (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f2), d2, d3);
			tessellator.addVertexWithUV((double) p_147756_2_ + 0.25D, (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f1), d2, d1);
			tessellator.addVertexWithUV((double) p_147756_2_, (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f1), d0, d1);
			tessellator.addVertexWithUV((double) p_147756_2_, (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f1), d0, d1);
			tessellator.addVertexWithUV((double) p_147756_2_ + 0.25D, (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f1), d2, d1);
		...
		if (flag2 || flag3 && !flag4 && !flag5) {
			tessellator.addVertexWithUV((double) p_147756_2_ + 0.25D, (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f2), d0, d3);
			tessellator.addVertexWithUV((double) p_147756_2_ + 0.5D, (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f2), d2, d3);
			tessellator.addVertexWithUV((double) p_147756_2_ + 0.5D, (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f1), d2, d1);
			tessellator.addVertexWithUV((double) p_147756_2_ + 0.25D, (double) p_147756_3_ + d4,
		...
		if (flag3 || flag2 && !flag4 && !flag5) {
			tessellator.addVertexWithUV((double) p_147756_2_ + 0.5D, (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f2), d0, d3);
			tessellator.addVertexWithUV((double) p_147756_2_ + 0.75D, (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f2), d2, d3);
			tessellator.addVertexWithUV((double) p_147756_2_ + 0.75D, (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f1), d2, d1);
			tessellator.addVertexWithUV((double) p_147756_2_ + 0.5D, (double) p_147756_3_ + d4,
		...
		if (flag3) {
			tessellator.addVertexWithUV((double) p_147756_2_ + 0.75D, (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f2), d0, d3);
			tessellator.addVertexWithUV((double) (p_147756_2_ + 1), (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f2), d2, d3);
			tessellator.addVertexWithUV((double) (p_147756_2_ + 1), (double) p_147756_3_ + d4,
					(double) ((float) p_147756_4_ + f1), d2, d1);
			tessellator.addVertexWithUV((double) p_147756_2_ + 0.75D, (double) p_147756_3_ + d4,
	...
	public boolean renderBlockFire(BlockFire p_147801_1_, int p_147801_2_, int p_147801_3_, int p_147801_4_) {
		...
		tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
		tessellator.setBrightness(
				p_147801_1_.getMixedBrightnessForBlock(this.blockAccess, p_147801_2_, p_147801_3_, p_147801_4_));
		...
		if (!World.doesBlockHaveSolidTopSurface(this.blockAccess, p_147801_2_, p_147801_3_ - 1, p_147801_4_)
				&& !Blocks.fire.canCatchFire(this.blockAccess, p_147801_2_, p_147801_3_ - 1, p_147801_4_, UP)) {
			float f2 = 0.2F;
			float f1 = 0.0625F;
			...
			if (Blocks.fire.canCatchFire(this.blockAccess, p_147801_2_ - 1, p_147801_3_, p_147801_4_, EAST)) {
				tessellator.addVertexWithUV((double) ((float) p_147801_2_ + f2),
						(double) ((float) p_147801_3_ + f + f1), (double) (p_147801_4_ + 1), d2, d1);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) (p_147801_3_ + 0) + f1),
						(double) (p_147801_4_ + 1), d2, d3);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) (p_147801_3_ + 0) + f1),
						(double) (p_147801_4_ + 0), d0, d3);
				tessellator.addVertexWithUV((double) ((float) p_147801_2_ + f2),
						(double) ((float) p_147801_3_ + f + f1), (double) (p_147801_4_ + 0), d0, d1);
				tessellator.addVertexWithUV((double) ((float) p_147801_2_ + f2),
						(double) ((float) p_147801_3_ + f + f1), (double) (p_147801_4_ + 0), d0, d1);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) (p_147801_3_ + 0) + f1),
						(double) (p_147801_4_ + 0), d0, d3);
			...
			if (Blocks.fire.canCatchFire(this.blockAccess, p_147801_2_ + 1, p_147801_3_, p_147801_4_, WEST)) {
				tessellator.addVertexWithUV((double) ((float) (p_147801_2_ + 1) - f2),
						(double) ((float) p_147801_3_ + f + f1), (double) (p_147801_4_ + 0), d0, d1);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 1 - 0), (double) ((float) (p_147801_3_ + 0) + f1),
						(double) (p_147801_4_ + 0), d0, d3);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 1 - 0), (double) ((float) (p_147801_3_ + 0) + f1),
						(double) (p_147801_4_ + 1), d2, d3);
				tessellator.addVertexWithUV((double) ((float) (p_147801_2_ + 1) - f2),
			...
			if (Blocks.fire.canCatchFire(this.blockAccess, p_147801_2_, p_147801_3_, p_147801_4_ - 1, SOUTH)) {
				tessellator.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) p_147801_3_ + f + f1),
						(double) ((float) p_147801_4_ + f2), d2, d1);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) (p_147801_3_ + 0) + f1),
						(double) (p_147801_4_ + 0), d2, d3);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) (p_147801_3_ + 0) + f1),
						(double) (p_147801_4_ + 0), d0, d3);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) p_147801_3_ + f + f1),
						(double) ((float) p_147801_4_ + f2), d0, d1);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) p_147801_3_ + f + f1),
						(double) ((float) p_147801_4_ + f2), d0, d1);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) (p_147801_3_ + 0) + f1),
						(double) (p_147801_4_ + 0), d0, d3);
			...
			if (Blocks.fire.canCatchFire(this.blockAccess, p_147801_2_, p_147801_3_, p_147801_4_ + 1, NORTH)) {
				tessellator.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) p_147801_3_ + f + f1),
						(double) ((float) (p_147801_4_ + 1) - f2), d0, d1);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) (p_147801_3_ + 0) + f1),
						(double) (p_147801_4_ + 1 - 0), d0, d3);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) (p_147801_3_ + 0) + f1),
						(double) (p_147801_4_ + 1 - 0), d2, d3);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) p_147801_3_ + f + f1),
						(double) ((float) (p_147801_4_ + 1) - f2), d2, d1);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) p_147801_3_ + f + f1),
						(double) ((float) (p_147801_4_ + 1) - f2), d2, d1);
				tessellator.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) (p_147801_3_ + 0) + f1),
						(double) (p_147801_4_ + 1 - 0), d2, d3);
			...
			if (Blocks.fire.canCatchFire(this.blockAccess, p_147801_2_, p_147801_3_ + 1, p_147801_4_, DOWN)) {
				...
				if ((p_147801_2_ + p_147801_3_ + p_147801_4_ & 1) == 0) {
					tessellator.addVertexWithUV(d9, (double) ((float) p_147801_3_ + f), (double) (p_147801_4_ + 0), d2,
							d1);
					...
					tessellator.addVertexWithUV(d9, (double) ((float) p_147801_3_ + f), (double) (p_147801_4_ + 1), d0,
							d1);
					d0 = (double) iicon1.getMinU();
					d1 = (double) iicon1.getMinV();
					d2 = (double) iicon1.getMaxU();
					d3 = (double) iicon1.getMaxV();
					tessellator.addVertexWithUV(d10, (double) ((float) p_147801_3_ + f), (double) (p_147801_4_ + 1), d2,
							d1);
					...
					tessellator.addVertexWithUV(d10, (double) ((float) p_147801_3_ + f), (double) (p_147801_4_ + 0), d0,
							d1);
				} else {
					tessellator.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) p_147801_3_ + f), d12, d2,
							d1);
					...
					tessellator.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) p_147801_3_ + f), d12, d0,
							d1);
					d0 = (double) iicon1.getMinU();
					d1 = (double) iicon1.getMinV();
					d2 = (double) iicon1.getMaxU();
					d3 = (double) iicon1.getMaxV();
					tessellator.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) p_147801_3_ + f), d11, d2,
							d1);
					...
					tessellator.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) p_147801_3_ + f), d11, d0,
							d1);
				}
			}
		} else {
	...
	public boolean renderBlockRedstoneWire(Block p_147788_1_, int p_147788_2_, int p_147788_3_, int p_147788_4_) {
		Tessellator tessellator = Tessellator.instance;
		int l = this.getMeta(p_147788_2_, p_147788_3_, p_147788_4_);
		...
		tessellator.setBrightness(
				p_147788_1_.getMixedBrightnessForBlock(this.blockAccess, p_147788_2_, p_147788_3_, p_147788_4_));
		...
		double d0 = 0.015625D;
		double d1 = 0.015625D;
		boolean flag = BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, p_147788_2_ - 1, p_147788_3_,
				p_147788_4_, 1)
				|| !this.blockAccess.getBlock(p_147788_2_ - 1, p_147788_3_, p_147788_4_).isBlockNormalCube()
						&& BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, p_147788_2_ - 1, p_147788_3_ - 1,
								p_147788_4_, -1);
		boolean flag1 = BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, p_147788_2_ + 1, p_147788_3_,
				p_147788_4_, 3)
				|| !this.blockAccess.getBlock(p_147788_2_ + 1, p_147788_3_, p_147788_4_).isBlockNormalCube()
						&& BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, p_147788_2_ + 1, p_147788_3_ - 1,
								p_147788_4_, -1);
		boolean flag2 = BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, p_147788_2_, p_147788_3_,
				p_147788_4_ - 1, 2)
				|| !this.blockAccess.getBlock(p_147788_2_, p_147788_3_, p_147788_4_ - 1).isBlockNormalCube()
						&& BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, p_147788_2_, p_147788_3_ - 1,
								p_147788_4_ - 1, -1);
		boolean flag3 = BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, p_147788_2_, p_147788_3_,
				p_147788_4_ + 1, 0)
				|| !this.blockAccess.getBlock(p_147788_2_, p_147788_3_, p_147788_4_ + 1).isBlockNormalCube()
						&& BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, p_147788_2_, p_147788_3_ - 1,
								p_147788_4_ + 1, -1);
		...
		if (i1 == 0) {
			...
			tessellator.addVertexWithUV((double) f5, (double) p_147788_3_ + 0.015625D, (double) f7,
					(double) iicon.getInterpolatedU((double) l1), (double) iicon.getInterpolatedV((double) i2));
			tessellator.addVertexWithUV((double) f5, (double) p_147788_3_ + 0.015625D, (double) f6,
					(double) iicon.getInterpolatedU((double) l1), (double) iicon.getInterpolatedV((double) k1));
			tessellator.addVertexWithUV((double) f4, (double) p_147788_3_ + 0.015625D, (double) f6,
					(double) iicon.getInterpolatedU((double) j1), (double) iicon.getInterpolatedV((double) k1));
			tessellator.addVertexWithUV((double) f4, (double) p_147788_3_ + 0.015625D, (double) f7,
		...
		if (!this.blockAccess.getBlock(p_147788_2_, p_147788_3_ + 1, p_147788_4_).isBlockNormalCube()) {
			...
			if (this.blockAccess.getBlock(p_147788_2_ - 1, p_147788_3_, p_147788_4_).isBlockNormalCube()
				...
				tessellator.setColorOpaque_F(f1, f2, f3);
				tessellator.addVertexWithUV((double) p_147788_2_ + 0.015625D,
						(double) ((float) (p_147788_3_ + 1) + 0.021875F), (double) (p_147788_4_ + 1),
						(double) iicon1.getMaxU(), (double) iicon1.getMinV());
				tessellator.addVertexWithUV((double) p_147788_2_ + 0.015625D, (double) (p_147788_3_ + 0),
						(double) (p_147788_4_ + 1), (double) iicon1.getMinU(), (double) iicon1.getMinV());
				tessellator.addVertexWithUV((double) p_147788_2_ + 0.015625D, (double) (p_147788_3_ + 0),
						(double) (p_147788_4_ + 0), (double) iicon1.getMinU(), (double) iicon1.getMaxV());
				tessellator.addVertexWithUV((double) p_147788_2_ + 0.015625D,
				...
				tessellator.addVertexWithUV((double) p_147788_2_ + 0.015625D,
						...
						(double) iicon3.getMaxU(), (double) iicon3.getMinV());
				tessellator.addVertexWithUV((double) p_147788_2_ + 0.015625D, (double) (p_147788_3_ + 0),
						(double) (p_147788_4_ + 1), (double) iicon3.getMinU(), (double) iicon3.getMinV());
				tessellator.addVertexWithUV((double) p_147788_2_ + 0.015625D, (double) (p_147788_3_ + 0),
						(double) (p_147788_4_ + 0), (double) iicon3.getMinU(), (double) iicon3.getMaxV());
				tessellator.addVertexWithUV((double) p_147788_2_ + 0.015625D,
						(double) ((float) (p_147788_3_ + 1) + 0.021875F), (double) (p_147788_4_ + 0),
						(double) iicon3.getMaxU(), (double) iicon3.getMaxV());
			}
			...
			if (this.blockAccess.getBlock(p_147788_2_ + 1, p_147788_3_, p_147788_4_).isBlockNormalCube()
					&& this.blockAccess.getBlock(p_147788_2_ + 1, p_147788_3_ + 1,
							p_147788_4_) == Blocks.redstone_wire) {
				tessellator.setColorOpaque_F(f1, f2, f3);
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D, (double) (p_147788_3_ + 0),
						(double) (p_147788_4_ + 1), (double) iicon1.getMinU(), (double) iicon1.getMaxV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D,
						(double) ((float) (p_147788_3_ + 1) + 0.021875F), (double) (p_147788_4_ + 1),
						(double) iicon1.getMaxU(), (double) iicon1.getMaxV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D,
						(double) ((float) (p_147788_3_ + 1) + 0.021875F), (double) (p_147788_4_ + 0),
						(double) iicon1.getMaxU(), (double) iicon1.getMinV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D, (double) (p_147788_3_ + 0),
						(double) (p_147788_4_ + 0), (double) iicon1.getMinU(), (double) iicon1.getMinV());
				tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D, (double) (p_147788_3_ + 0),
						(double) (p_147788_4_ + 1), (double) iicon3.getMinU(), (double) iicon3.getMaxV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D,
						(double) ((float) (p_147788_3_ + 1) + 0.021875F), (double) (p_147788_4_ + 1),
						(double) iicon3.getMaxU(), (double) iicon3.getMaxV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D,
						...
						(double) iicon3.getMaxU(), (double) iicon3.getMinV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D, (double) (p_147788_3_ + 0),
						(double) (p_147788_4_ + 0), (double) iicon3.getMinU(), (double) iicon3.getMinV());
			}
			...
			if (this.blockAccess.getBlock(p_147788_2_, p_147788_3_, p_147788_4_ - 1).isBlockNormalCube()
				...
				tessellator.setColorOpaque_F(f1, f2, f3);
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1), (double) (p_147788_3_ + 0),
						(double) p_147788_4_ + 0.015625D, (double) iicon1.getMinU(), (double) iicon1.getMaxV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1),
						(double) ((float) (p_147788_3_ + 1) + 0.021875F), (double) p_147788_4_ + 0.015625D,
						(double) iicon1.getMaxU(), (double) iicon1.getMaxV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 0),
						(double) ((float) (p_147788_3_ + 1) + 0.021875F), (double) p_147788_4_ + 0.015625D,
						(double) iicon1.getMaxU(), (double) iicon1.getMinV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 0), (double) (p_147788_3_ + 0),
						(double) p_147788_4_ + 0.015625D, (double) iicon1.getMinU(), (double) iicon1.getMinV());
				tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1), (double) (p_147788_3_ + 0),
						(double) p_147788_4_ + 0.015625D, (double) iicon3.getMinU(), (double) iicon3.getMaxV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1),
						(double) ((float) (p_147788_3_ + 1) + 0.021875F), (double) p_147788_4_ + 0.015625D,
						(double) iicon3.getMaxU(), (double) iicon3.getMaxV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 0),
						...
						(double) iicon3.getMaxU(), (double) iicon3.getMinV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 0), (double) (p_147788_3_ + 0),
						(double) p_147788_4_ + 0.015625D, (double) iicon3.getMinU(), (double) iicon3.getMinV());
			}
			...
			if (this.blockAccess.getBlock(p_147788_2_, p_147788_3_, p_147788_4_ + 1).isBlockNormalCube()
				...
				tessellator.setColorOpaque_F(f1, f2, f3);
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1),
						(double) ((float) (p_147788_3_ + 1) + 0.021875F), (double) (p_147788_4_ + 1) - 0.015625D,
						(double) iicon1.getMaxU(), (double) iicon1.getMinV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1), (double) (p_147788_3_ + 0),
						(double) (p_147788_4_ + 1) - 0.015625D, (double) iicon1.getMinU(), (double) iicon1.getMinV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 0), (double) (p_147788_3_ + 0),
						(double) (p_147788_4_ + 1) - 0.015625D, (double) iicon1.getMinU(), (double) iicon1.getMaxV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 0),
						(double) ((float) (p_147788_3_ + 1) + 0.021875F), (double) (p_147788_4_ + 1) - 0.015625D,
						(double) iicon1.getMaxU(), (double) iicon1.getMaxV());
				tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1),
						...
						(double) iicon3.getMaxU(), (double) iicon3.getMinV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 1), (double) (p_147788_3_ + 0),
						(double) (p_147788_4_ + 1) - 0.015625D, (double) iicon3.getMinU(), (double) iicon3.getMinV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 0), (double) (p_147788_3_ + 0),
						(double) (p_147788_4_ + 1) - 0.015625D, (double) iicon3.getMinU(), (double) iicon3.getMaxV());
				tessellator.addVertexWithUV((double) (p_147788_2_ + 0),
						(double) ((float) (p_147788_3_ + 1) + 0.021875F), (double) (p_147788_4_ + 1) - 0.015625D,
						(double) iicon3.getMaxU(), (double) iicon3.getMaxV());
			}
	...
	public boolean renderBlockMinecartTrack(BlockRailBase p_147766_1_, int p_147766_2_, int p_147766_3_,
			int p_147766_4_) {
		Tessellator tessellator = Tessellator.instance;
		int l = this.getMeta(p_147766_2_, p_147766_3_, p_147766_4_);
		...
		tessellator.setBrightness(
				p_147766_1_.getMixedBrightnessForBlock(this.blockAccess, p_147766_2_, p_147766_3_, p_147766_4_));
		tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
		double d0 = (double) iicon.getMinU();
		double d1 = (double) iicon.getMinV();
		double d2 = (double) iicon.getMaxU();
	...
	public boolean renderBlockLadder(Block p_147794_1_, int p_147794_2_, int p_147794_3_, int p_147794_4_) {
		...
		tessellator.setBrightness(
				p_147794_1_.getMixedBrightnessForBlock(this.blockAccess, p_147794_2_, p_147794_3_, p_147794_4_));
		tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
		double d0 = (double) iicon.getMinU();
		double d1 = (double) iicon.getMinV();
		double d2 = (double) iicon.getMaxU();
		double d3 = (double) iicon.getMaxV();
		int l = this.getMeta(p_147794_2_, p_147794_3_, p_147794_4_);
		double d4 = 0.0D;
		double d5 = 0.05000000074505806D;

		if (l == 5) {
			tessellator.addVertexWithUV((double) p_147794_2_ + d5, (double) (p_147794_3_ + 1) + d4,
					(double) (p_147794_4_ + 1) + d4, d0, d1);
			tessellator.addVertexWithUV((double) p_147794_2_ + d5, (double) (p_147794_3_ + 0) - d4,
					(double) (p_147794_4_ + 1) + d4, d0, d3);
			tessellator.addVertexWithUV((double) p_147794_2_ + d5, (double) (p_147794_3_ + 0) - d4,
					(double) (p_147794_4_ + 0) - d4, d2, d3);
			tessellator.addVertexWithUV((double) p_147794_2_ + d5, (double) (p_147794_3_ + 1) + d4,
					(double) (p_147794_4_ + 0) - d4, d2, d1);
		}

		if (l == 4) {
			tessellator.addVertexWithUV((double) (p_147794_2_ + 1) - d5, (double) (p_147794_3_ + 0) - d4,
					(double) (p_147794_4_ + 1) + d4, d2, d3);
			tessellator.addVertexWithUV((double) (p_147794_2_ + 1) - d5, (double) (p_147794_3_ + 1) + d4,
					(double) (p_147794_4_ + 1) + d4, d2, d1);
			tessellator.addVertexWithUV((double) (p_147794_2_ + 1) - d5, (double) (p_147794_3_ + 1) + d4,
					(double) (p_147794_4_ + 0) - d4, d0, d1);
			tessellator.addVertexWithUV((double) (p_147794_2_ + 1) - d5, (double) (p_147794_3_ + 0) - d4,
					(double) (p_147794_4_ + 0) - d4, d0, d3);
		}

		if (l == 3) {
			tessellator.addVertexWithUV((double) (p_147794_2_ + 1) + d4, (double) (p_147794_3_ + 0) - d4,
					(double) p_147794_4_ + d5, d2, d3);
			tessellator.addVertexWithUV((double) (p_147794_2_ + 1) + d4, (double) (p_147794_3_ + 1) + d4,
					(double) p_147794_4_ + d5, d2, d1);
			tessellator.addVertexWithUV((double) (p_147794_2_ + 0) - d4, (double) (p_147794_3_ + 1) + d4,
					(double) p_147794_4_ + d5, d0, d1);
			tessellator.addVertexWithUV((double) (p_147794_2_ + 0) - d4, (double) (p_147794_3_ + 0) - d4,
					(double) p_147794_4_ + d5, d0, d3);
		}

		if (l == 2) {
			tessellator.addVertexWithUV((double) (p_147794_2_ + 1) + d4, (double) (p_147794_3_ + 1) + d4,
					(double) (p_147794_4_ + 1) - d5, d0, d1);
			tessellator.addVertexWithUV((double) (p_147794_2_ + 1) + d4, (double) (p_147794_3_ + 0) - d4,
					(double) (p_147794_4_ + 1) - d5, d0, d3);
			tessellator.addVertexWithUV((double) (p_147794_2_ + 0) - d4, (double) (p_147794_3_ + 0) - d4,
					(double) (p_147794_4_ + 1) - d5, d2, d3);
			tessellator.addVertexWithUV((double) (p_147794_2_ + 0) - d4, (double) (p_147794_3_ + 1) + d4,
					(double) (p_147794_4_ + 1) - d5, d2, d1);
		}
	...
	public boolean renderBlockVine(Block p_147726_1_, int p_147726_2_, int p_147726_3_, int p_147726_4_) {
		...
		tessellator.setBrightness(
				p_147726_1_.getMixedBrightnessForBlock(this.blockAccess, p_147726_2_, p_147726_3_, p_147726_4_));
		...
		int i1 = this.getMeta(p_147726_2_, p_147726_3_, p_147726_4_);

		if ((i1 & 2) != 0) {
			tessellator.addVertexWithUV((double) p_147726_2_ + d2, (double) (p_147726_3_ + 1),
					(double) (p_147726_4_ + 1), d3, d4);
			tessellator.addVertexWithUV((double) p_147726_2_ + d2, (double) (p_147726_3_ + 0),
					(double) (p_147726_4_ + 1), d3, d1);
			tessellator.addVertexWithUV((double) p_147726_2_ + d2, (double) (p_147726_3_ + 0),
					(double) (p_147726_4_ + 0), d0, d1);
			tessellator.addVertexWithUV((double) p_147726_2_ + d2, (double) (p_147726_3_ + 1),
					(double) (p_147726_4_ + 0), d0, d4);
			tessellator.addVertexWithUV((double) p_147726_2_ + d2, (double) (p_147726_3_ + 1),
					(double) (p_147726_4_ + 0), d0, d4);
			tessellator.addVertexWithUV((double) p_147726_2_ + d2, (double) (p_147726_3_ + 0),
					(double) (p_147726_4_ + 0), d0, d1);
		...
		if ((i1 & 8) != 0) {
			tessellator.addVertexWithUV((double) (p_147726_2_ + 1) - d2, (double) (p_147726_3_ + 0),
					(double) (p_147726_4_ + 1), d0, d1);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 1) - d2, (double) (p_147726_3_ + 1),
					(double) (p_147726_4_ + 1), d0, d4);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 1) - d2, (double) (p_147726_3_ + 1),
					(double) (p_147726_4_ + 0), d3, d4);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 1) - d2, (double) (p_147726_3_ + 0),
					(double) (p_147726_4_ + 0), d3, d1);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 1) - d2, (double) (p_147726_3_ + 0),
					(double) (p_147726_4_ + 0), d3, d1);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 1) - d2, (double) (p_147726_3_ + 1),
					(double) (p_147726_4_ + 0), d3, d4);
		...
		if ((i1 & 4) != 0) {
			tessellator.addVertexWithUV((double) (p_147726_2_ + 1), (double) (p_147726_3_ + 0),
					(double) p_147726_4_ + d2, d0, d1);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 1), (double) (p_147726_3_ + 1),
					(double) p_147726_4_ + d2, d0, d4);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 1),
					(double) p_147726_4_ + d2, d3, d4);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 0),
					(double) p_147726_4_ + d2, d3, d1);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 0),
					(double) p_147726_4_ + d2, d3, d1);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 1),
					(double) p_147726_4_ + d2, d3, d4);
		...
		if ((i1 & 1) != 0) {
			tessellator.addVertexWithUV((double) (p_147726_2_ + 1), (double) (p_147726_3_ + 1),
					(double) (p_147726_4_ + 1) - d2, d3, d4);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 1), (double) (p_147726_3_ + 0),
					(double) (p_147726_4_ + 1) - d2, d3, d1);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 0),
					(double) (p_147726_4_ + 1) - d2, d0, d1);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 1),
					(double) (p_147726_4_ + 1) - d2, d0, d4);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 1),
					(double) (p_147726_4_ + 1) - d2, d0, d4);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 0),
					(double) (p_147726_4_ + 1) - d2, d0, d1);
		...
		if (this.blockAccess.getBlock(p_147726_2_, p_147726_3_ + 1, p_147726_4_).isBlockNormalCube()) {
			tessellator.addVertexWithUV((double) (p_147726_2_ + 1), (double) (p_147726_3_ + 1) - d2,
					(double) (p_147726_4_ + 0), d3, d4);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 1), (double) (p_147726_3_ + 1) - d2,
					(double) (p_147726_4_ + 1), d3, d1);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 1) - d2,
					(double) (p_147726_4_ + 1), d0, d1);
			tessellator.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 1) - d2,
					(double) (p_147726_4_ + 0), d0, d4);
		}
	...
	public boolean renderBlockStainedGlassPane(Block p_147733_1_, int p_147733_2_, int p_147733_3_, int p_147733_4_) {
		...
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147733_1_.getMixedBrightnessForBlock(this.blockAccess, p_147733_2_, p_147733_3_, p_147733_4_));
		...
		if (this.hasOverrideBlockTexture()) {
			...
			int j1 = this.getMeta(p_147733_2_, p_147733_3_, p_147733_4_);
		...
		boolean flag = ((BlockPane) p_147733_1_).canPaneConnectTo(this.blockAccess, p_147733_2_, p_147733_3_,
				p_147733_4_ - 1, NORTH);
		boolean flag1 = ((BlockPane) p_147733_1_).canPaneConnectTo(this.blockAccess, p_147733_2_, p_147733_3_,
				p_147733_4_ + 1, SOUTH);
		boolean flag2 = ((BlockPane) p_147733_1_).canPaneConnectTo(this.blockAccess, p_147733_2_ - 1, p_147733_3_,
				p_147733_4_, WEST);
		boolean flag3 = ((BlockPane) p_147733_1_).canPaneConnectTo(this.blockAccess, p_147733_2_ + 1, p_147733_3_,
				p_147733_4_, EAST);
		double d19 = 0.001D;
		double d20 = 0.999D;
		double d21 = 0.001D;
	...
	public boolean renderBlockPane(BlockPane p_147767_1_, int p_147767_2_, int p_147767_3_, int p_147767_4_) {
		...
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147767_1_.getMixedBrightnessForBlock(this.blockAccess, p_147767_2_, p_147767_3_, p_147767_4_));
		...
		if (this.hasOverrideBlockTexture()) {
			...
			int j1 = this.getMeta(p_147767_2_, p_147767_3_, p_147767_4_);
		...
		boolean flag1 = p_147767_1_.canPaneConnectTo(this.blockAccess, p_147767_2_, p_147767_3_, p_147767_4_ + 1,
				SOUTH);
		...
		boolean flag4 = p_147767_1_.shouldSideBeRendered(this.blockAccess, p_147767_2_, p_147767_3_ + 1, p_147767_4_,
				1);
		boolean flag5 = p_147767_1_.shouldSideBeRendered(this.blockAccess, p_147767_2_, p_147767_3_ - 1, p_147767_4_,
				0);
		double d19 = 0.01D;
		double d20 = 0.005D;
	...
	@Override
	/**
	 * Renders any block requiring crossed squares such as reeds, flowers, and
	 * mushrooms
	 */
	public boolean renderCrossedSquares(Block p_147746_1_, int p_147746_2_, int p_147746_3_, int p_147746_4_) {
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147746_1_.getMixedBrightnessForBlock(this.blockAccess, p_147746_2_, p_147746_3_, p_147746_4_));
		...
		IIcon iicon = this.getBlockIconFromSideAndMetadata(p_147746_1_, 0,
				this.getMeta(p_147746_2_, p_147746_3_, p_147746_4_));
	...
	public boolean renderBlockDoublePlant(BlockDoublePlant p_147774_1_, int p_147774_2_, int p_147774_3_,
		...
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147774_1_.getMixedBrightnessForBlock(this.blockAccess, p_147774_2_, p_147774_3_, p_147774_4_));
		...
		int i1 = this.getMeta(p_147774_2_, p_147774_3_, p_147774_4_);
		boolean flag = false;
		...
		if (flag1) {
			...
			k1 = BlockDoublePlant.func_149890_d(this.getMeta(p_147774_2_, p_147774_3_ - 1, p_147774_4_));
		} else {
	...
	public boolean renderBlockStem(Block p_147724_1_, int p_147724_2_, int p_147724_3_, int p_147724_4_) {
		...
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				blockstem.getMixedBrightnessForBlock(this.blockAccess, p_147724_2_, p_147724_3_, p_147724_4_));
		...
		if (i1 < 0) {
			this.renderBlockStemSmall(blockstem, this.getMeta(p_147724_2_, p_147724_3_, p_147724_4_), this.renderMaxY,
					(double) p_147724_2_, (double) ((float) p_147724_3_ - 0.0625F), (double) p_147724_4_);
		} else {
			this.renderBlockStemSmall(blockstem, this.getMeta(p_147724_2_, p_147724_3_, p_147724_4_), 0.5D,
					(double) p_147724_2_, (double) ((float) p_147724_3_ - 0.0625F), (double) p_147724_4_);
			this.renderBlockStemBig(blockstem, this.getMeta(p_147724_2_, p_147724_3_, p_147724_4_), i1, this.renderMaxY,
					(double) p_147724_2_, (double) ((float) p_147724_3_ - 0.0625F), (double) p_147724_4_);
		}
	...
	public boolean renderBlockCrops(Block p_147796_1_, int p_147796_2_, int p_147796_3_, int p_147796_4_) {
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147796_1_.getMixedBrightnessForBlock(this.blockAccess, p_147796_2_, p_147796_3_, p_147796_4_));
		tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
		this.renderBlockCropsImpl(p_147796_1_, this.getMeta(p_147796_2_, p_147796_3_, p_147796_4_),
	...
	public boolean renderBlockLilyPad(Block p_147783_1_, int p_147783_2_, int p_147783_3_, int p_147783_4_) {
		...
		int i1 = (int) (l >> 16 & 3L);
		tessellator.setBrightness(
				p_147783_1_.getMixedBrightnessForBlock(this.blockAccess, p_147783_2_, p_147783_3_, p_147783_4_));
		...
		tessellator.addVertexWithUV((double) (f1 + f3 - f4), (double) ((float) p_147783_3_ + f),
				(double) (f2 + f3 + f4), d0, d1);
		tessellator.addVertexWithUV((double) (f1 + f3 + f4), (double) ((float) p_147783_3_ + f),
				(double) (f2 - f3 + f4), d2, d1);
		tessellator.addVertexWithUV((double) (f1 - f3 + f4), (double) ((float) p_147783_3_ + f),
				(double) (f2 - f3 - f4), d2, d3);
		tessellator.addVertexWithUV((double) (f1 - f3 - f4), (double) ((float) p_147783_3_ + f),
				(double) (f2 + f3 - f4), d0, d3);
	...
	public boolean renderBlockLiquid(Block p_147721_1_, int p_147721_2_, int p_147721_3_, int p_147721_4_) {
		...
		boolean flag1 = p_147721_1_.shouldSideBeRendered(this.blockAccess, p_147721_2_, p_147721_3_ - 1, p_147721_4_,
				0);
		...
		if (!flag && !flag1 && !aboolean[0] && !aboolean[1] && !aboolean[2] && !aboolean[3]) {
			...
			int i1 = this.getMeta(p_147721_2_, p_147721_3_, p_147721_4_);
			...
			if (this.renderAllFaces || flag) {
				...
				float f7 = (float) BlockLiquid.getFlowDirection(this.blockAccess, p_147721_2_, p_147721_3_, p_147721_4_,
						material);
				...
				tessellator.setBrightness(p_147721_1_.getMixedBrightnessForBlock(this.blockAccess, p_147721_2_,
						p_147721_3_, p_147721_4_));
				tessellator.setColorOpaque_F(f4 * f, f4 * f1, f4 * f2);
				tessellator.addVertexWithUV((double) (p_147721_2_ + 0), (double) p_147721_3_ + d2,
						(double) (p_147721_4_ + 0), d7, d14);
				tessellator.addVertexWithUV((double) (p_147721_2_ + 0), (double) p_147721_3_ + d3,
						(double) (p_147721_4_ + 1), d8, d16);
				tessellator.addVertexWithUV((double) (p_147721_2_ + 1), (double) p_147721_3_ + d4,
						(double) (p_147721_4_ + 1), d10, d18);
				tessellator.addVertexWithUV((double) (p_147721_2_ + 1), (double) p_147721_3_ + d5,
						(double) (p_147721_4_ + 0), d12, d20);
				tessellator.addVertexWithUV((double) (p_147721_2_ + 0), (double) p_147721_3_ + d2,
						(double) (p_147721_4_ + 0), d7, d14);
				tessellator.addVertexWithUV((double) (p_147721_2_ + 1), (double) p_147721_3_ + d5,
						(double) (p_147721_4_ + 0), d12, d20);
			...
			if (this.renderAllFaces || flag1) {
				tessellator.setBrightness(p_147721_1_.getMixedBrightnessForBlock(this.blockAccess, p_147721_2_,
						p_147721_3_ - 1, p_147721_4_));
				tessellator.setColorOpaque_F(f3, f3, f3);
				this.renderFaceYNeg(p_147721_1_, (double) p_147721_2_, (double) p_147721_3_ + d6, (double) p_147721_4_,
						this.getBlockIconFromSide(p_147721_1_, 0));
				flag2 = true;
			}
			...
			for (int k1 = 0; k1 < 4; ++k1) {
				...
				if (this.renderAllFaces || aboolean[k1]) {
					...
					tessellator.setBrightness(
							p_147721_1_.getMixedBrightnessForBlock(this.blockAccess, l1, p_147721_3_, j1));
					float f13 = 1.0F;
					f13 *= k1 < 2 ? f5 : f6;
	...
	public float getLiquidHeight(int p_147729_1_, int p_147729_2_, int p_147729_3_, Material p_147729_4_) {
		...
		for (int i1 = 0; i1 < 4; ++i1) {
			...
			if (material1 == p_147729_4_) {
				int l1 = this.getMeta(j1, p_147729_2_, k1);
		...
		return Minecraft.isAmbientOcclusionEnabled() && p_147784_1_.getLightValue() == 0
				? (this.partialRenderBounds
						...
						: this.renderStandardBlockWithAmbientOcclusion(p_147784_1_, p_147784_2_, p_147784_3_,
								p_147784_4_, f, f1, f2))
				: this.renderStandardBlockWithColorMultiplier(p_147784_1_, p_147784_2_, p_147784_3_, p_147784_4_, f, f1,
						f2);
	}
	@Override
	public boolean renderBlockLog(Block p_147742_1_, int p_147742_2_, int p_147742_3_, int p_147742_4_) {
		int l = this.getMeta(p_147742_2_, p_147742_3_, p_147742_4_);
		int i1 = l & 12;
	...
	public boolean renderBlockQuartz(Block p_147779_1_, int p_147779_2_, int p_147779_3_, int p_147779_4_) {
		int l = this.getMeta(p_147779_2_, p_147779_3_, p_147779_4_);
	...
	public boolean renderStandardBlockWithAmbientOcclusion(Block p_147751_1_, int p_147751_2_, int p_147751_3_,
		...
		if (this.renderAllFaces
			...
			this.aoBrightnessXYNN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ - 1,
					p_147751_3_, p_147751_4_);
			this.aoBrightnessYZNN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_,
					p_147751_4_ - 1);
			this.aoBrightnessYZNP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_,
					p_147751_4_ + 1);
			this.aoBrightnessXYPN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ + 1,
					p_147751_3_, p_147751_4_);
			...
			if (!flag5 && !flag3) {
				...
				this.aoBrightnessXYZNNN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ - 1,
			...
			if (!flag4 && !flag3) {
				...
				this.aoLightValueScratchXYZNNP = this.blockAccess
						.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZNNP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ - 1,
						p_147751_3_, p_147751_4_ + 1);
			}
			...
			if (!flag5 && !flag2) {
				...
				this.aoLightValueScratchXYZPNN = this.blockAccess
						.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ - 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPNN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ + 1,
						p_147751_3_, p_147751_4_ - 1);
			}
			...
			if (!flag4 && !flag2) {
				...
				this.aoLightValueScratchXYZPNP = this.blockAccess
						.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPNP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ + 1,
						p_147751_3_, p_147751_4_ + 1);
			}
			...
			if (this.renderMinY <= 0.0D
				...
				i1 = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_ - 1,
						p_147751_4_);
			}
		...
		if (this.renderAllFaces
			...
			this.aoBrightnessXYNP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ - 1,
					p_147751_3_, p_147751_4_);
			this.aoBrightnessXYPP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ + 1,
					p_147751_3_, p_147751_4_);
			this.aoBrightnessYZPN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_,
					p_147751_4_ - 1);
			this.aoBrightnessYZPP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_,
					p_147751_4_ + 1);
			...
			if (!flag5 && !flag3) {
				...
				this.aoLightValueScratchXYZNPN = this.blockAccess
						.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ - 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZNPN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ - 1,
						p_147751_3_, p_147751_4_ - 1);
			}
			...
			if (!flag5 && !flag2) {
				...
				this.aoLightValueScratchXYZPPN = this.blockAccess
						.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ - 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPPN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ + 1,
						p_147751_3_, p_147751_4_ - 1);
			}
			...
			if (!flag4 && !flag3) {
				...
				this.aoLightValueScratchXYZNPP = this.blockAccess
						.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZNPP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ - 1,
						p_147751_3_, p_147751_4_ + 1);
			}
			...
			if (!flag4 && !flag2) {
				...
				this.aoLightValueScratchXYZPPP = this.blockAccess
						.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPPP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ + 1,
						p_147751_3_, p_147751_4_ + 1);
			}
		...
		if (this.renderAllFaces
			...
			this.aoLightValueScratchXZPN = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_)
					.getAmbientOcclusionLightValue();
			this.aoBrightnessXZNN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ - 1,
					p_147751_3_, p_147751_4_);
			this.aoBrightnessYZNN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
					p_147751_3_ - 1, p_147751_4_);
			this.aoBrightnessYZPN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
					p_147751_3_ + 1, p_147751_4_);
			this.aoBrightnessXZPN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ + 1,
					p_147751_3_, p_147751_4_);
			...
			if (this.renderMinZ <= 0.0D
				...
				i1 = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_,
						p_147751_4_ - 1);
			}
		...
		if (this.renderAllFaces
			...
			this.aoLightValueScratchYZPP = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_)
					.getAmbientOcclusionLightValue();
			this.aoBrightnessXZNP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ - 1,
					p_147751_3_, p_147751_4_);
			this.aoBrightnessXZPP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ + 1,
					p_147751_3_, p_147751_4_);
			this.aoBrightnessYZNP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
					p_147751_3_ - 1, p_147751_4_);
			this.aoBrightnessYZPP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
					p_147751_3_ + 1, p_147751_4_);
			flag2 = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ + 1).getCanBlockGrass();
			flag3 = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ + 1).getCanBlockGrass();
			flag4 = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_ + 1).getCanBlockGrass();
		...
		if (this.renderAllFaces
			...
			this.aoLightValueScratchXYNP = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_)
					.getAmbientOcclusionLightValue();
			this.aoBrightnessXYNN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
					p_147751_3_ - 1, p_147751_4_);
			this.aoBrightnessXZNN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_,
					p_147751_4_ - 1);
			this.aoBrightnessXZNP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_,
					p_147751_4_ + 1);
			this.aoBrightnessXYNP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
					p_147751_3_ + 1, p_147751_4_);
			flag2 = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_ + 1, p_147751_4_).getCanBlockGrass();
			flag3 = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_ - 1, p_147751_4_).getCanBlockGrass();
			...
			if (!flag4 && !flag3) {
				...
				this.aoBrightnessXYZNNN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
			...
			if (!flag5 && !flag3) {
				...
				this.aoLightValueScratchXYZNNP = this.blockAccess
						.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZNNP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
						p_147751_3_ - 1, p_147751_4_ + 1);
			}
			...
			if (!flag4 && !flag2) {
				...
				this.aoLightValueScratchXYZNPN = this.blockAccess
						.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_ - 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZNPN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
						p_147751_3_ + 1, p_147751_4_ - 1);
			}
			...
			if (!flag5 && !flag2) {
				...
				this.aoLightValueScratchXYZNPP = this.blockAccess
						.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZNPP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
						p_147751_3_ + 1, p_147751_4_ + 1);
			}
			...
			if (this.renderMinX <= 0.0D
				...
				i1 = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ - 1, p_147751_3_,
						p_147751_4_);
			}
		...
		if (this.renderAllFaces
			...
			this.aoLightValueScratchXYPP = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_)
					.getAmbientOcclusionLightValue();
			this.aoBrightnessXYPN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
					p_147751_3_ - 1, p_147751_4_);
			this.aoBrightnessXZPN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_,
					p_147751_4_ - 1);
			this.aoBrightnessXZPP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_,
					p_147751_4_ + 1);
			this.aoBrightnessXYPP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
					p_147751_3_ + 1, p_147751_4_);
			flag2 = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_ + 1, p_147751_4_).getCanBlockGrass();
			flag3 = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_ - 1, p_147751_4_).getCanBlockGrass();
			flag4 = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ + 1).getCanBlockGrass();
			...
			if (!flag3 && !flag5) {
				...
				this.aoLightValueScratchXYZPNN = this.blockAccess
						.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_ - 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPNN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
						p_147751_3_ - 1, p_147751_4_ - 1);
			}
			...
			if (!flag3 && !flag4) {
				...
				this.aoLightValueScratchXYZPNP = this.blockAccess
						.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPNP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
						p_147751_3_ - 1, p_147751_4_ + 1);
			}
			...
			if (!flag2 && !flag5) {
				...
				this.aoLightValueScratchXYZPPN = this.blockAccess
						.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_ - 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPPN = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
						p_147751_3_ + 1, p_147751_4_ - 1);
			}
			...
			if (!flag2 && !flag4) {
				...
				this.aoLightValueScratchXYZPPP = this.blockAccess
						.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPPP = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_,
						p_147751_3_ + 1, p_147751_4_ + 1);
			}
	...
	@Override
	/**
	 * Renders non-full-cube block with ambient occusion. Args: block, x, y, z, red,
	 * green, blue (lighting)
	 */
	public boolean renderStandardBlockWithAmbientOcclusionPartial(Block p_147808_1_, int p_147808_2_, int p_147808_3_,
		...
		if (this.renderAllFaces
			...
			this.aoBrightnessXYNN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ - 1,
					p_147808_3_, p_147808_4_);
			this.aoBrightnessYZNN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_,
					p_147808_4_ - 1);
			this.aoBrightnessYZNP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_,
					p_147808_4_ + 1);
			this.aoBrightnessXYPN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ + 1,
					p_147808_3_, p_147808_4_);
			...
			if (!flag5 && !flag3) {
				...
				this.aoBrightnessXYZNNN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ - 1,
			...
			if (!flag4 && !flag3) {
				...
				this.aoLightValueScratchXYZNNP = this.blockAccess
						.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZNNP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ - 1,
						p_147808_3_, p_147808_4_ + 1);
			}
			...
			if (!flag5 && !flag2) {
				...
				this.aoLightValueScratchXYZPNN = this.blockAccess
						.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ - 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPNN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ + 1,
						p_147808_3_, p_147808_4_ - 1);
			}
			...
			if (!flag4 && !flag2) {
				...
				this.aoLightValueScratchXYZPNP = this.blockAccess
						.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPNP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ + 1,
						p_147808_3_, p_147808_4_ + 1);
			}
			...
			if (this.renderMinY <= 0.0D
				...
				i1 = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_ - 1,
						p_147808_4_);
			}
		...
		if (this.renderAllFaces
			...
			this.aoBrightnessXYNP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ - 1,
					p_147808_3_, p_147808_4_);
			this.aoBrightnessXYPP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ + 1,
					p_147808_3_, p_147808_4_);
			this.aoBrightnessYZPN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_,
					p_147808_4_ - 1);
			this.aoBrightnessYZPP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_,
					p_147808_4_ + 1);
			...
			if (!flag5 && !flag3) {
				...
				this.aoLightValueScratchXYZNPN = this.blockAccess
						.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ - 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZNPN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ - 1,
						p_147808_3_, p_147808_4_ - 1);
			}
			...
			if (!flag5 && !flag2) {
				...
				this.aoLightValueScratchXYZPPN = this.blockAccess
						.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ - 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPPN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ + 1,
						p_147808_3_, p_147808_4_ - 1);
			}
			...
			if (!flag4 && !flag3) {
				...
				this.aoLightValueScratchXYZNPP = this.blockAccess
						.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZNPP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ - 1,
						p_147808_3_, p_147808_4_ + 1);
			}
			...
			if (!flag4 && !flag2) {
				...
				this.aoLightValueScratchXYZPPP = this.blockAccess
						.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPPP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ + 1,
						p_147808_3_, p_147808_4_ + 1);
			}
		...
		if (this.renderAllFaces
			...
			this.aoLightValueScratchXZPN = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_)
					.getAmbientOcclusionLightValue();
			this.aoBrightnessXZNN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ - 1,
					p_147808_3_, p_147808_4_);
			this.aoBrightnessYZNN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
					p_147808_3_ - 1, p_147808_4_);
			this.aoBrightnessYZPN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
					p_147808_3_ + 1, p_147808_4_);
			this.aoBrightnessXZPN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ + 1,
					p_147808_3_, p_147808_4_);
			...
			if (this.renderMinZ <= 0.0D
				...
				i1 = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_,
						p_147808_4_ - 1);
			}
		...
		if (this.renderAllFaces
			...
			this.aoLightValueScratchYZPP = this.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_)
					.getAmbientOcclusionLightValue();
			this.aoBrightnessXZNP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ - 1,
					p_147808_3_, p_147808_4_);
			this.aoBrightnessXZPP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ + 1,
					p_147808_3_, p_147808_4_);
			this.aoBrightnessYZNP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
					p_147808_3_ - 1, p_147808_4_);
			this.aoBrightnessYZPP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
					p_147808_3_ + 1, p_147808_4_);
			flag2 = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ + 1).getCanBlockGrass();
			flag3 = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ + 1).getCanBlockGrass();
			flag4 = this.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_ + 1).getCanBlockGrass();
		...
		if (this.renderAllFaces
			...
			this.aoLightValueScratchXYNP = this.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_)
					.getAmbientOcclusionLightValue();
			this.aoBrightnessXYNN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
					p_147808_3_ - 1, p_147808_4_);
			this.aoBrightnessXZNN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_,
					p_147808_4_ - 1);
			this.aoBrightnessXZNP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_,
					p_147808_4_ + 1);
			this.aoBrightnessXYNP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
					p_147808_3_ + 1, p_147808_4_);
			flag2 = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_ + 1, p_147808_4_).getCanBlockGrass();
			flag3 = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_ - 1, p_147808_4_).getCanBlockGrass();
			...
			if (!flag4 && !flag3) {
				...
				this.aoBrightnessXYZNNN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
			...
			if (!flag5 && !flag3) {
				...
				this.aoLightValueScratchXYZNNP = this.blockAccess
						.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZNNP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
						p_147808_3_ - 1, p_147808_4_ + 1);
			}
			...
			if (!flag4 && !flag2) {
				...
				this.aoLightValueScratchXYZNPN = this.blockAccess
						.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_ - 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZNPN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
						p_147808_3_ + 1, p_147808_4_ - 1);
			}
			...
			if (!flag5 && !flag2) {
				...
				this.aoLightValueScratchXYZNPP = this.blockAccess
						.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZNPP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
						p_147808_3_ + 1, p_147808_4_ + 1);
			}
			...
			if (this.renderMinX <= 0.0D
				...
				i1 = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ - 1, p_147808_3_,
						p_147808_4_);
			}
		...
		if (this.renderAllFaces
			...
			this.aoLightValueScratchXYPP = this.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_)
					.getAmbientOcclusionLightValue();
			this.aoBrightnessXYPN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
					p_147808_3_ - 1, p_147808_4_);
			this.aoBrightnessXZPN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_,
					p_147808_4_ - 1);
			this.aoBrightnessXZPP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_,
					p_147808_4_ + 1);
			this.aoBrightnessXYPP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
					p_147808_3_ + 1, p_147808_4_);
			flag2 = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_ + 1, p_147808_4_).getCanBlockGrass();
			flag3 = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_ - 1, p_147808_4_).getCanBlockGrass();
			flag4 = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ + 1).getCanBlockGrass();
			...
			if (!flag3 && !flag5) {
				...
				this.aoLightValueScratchXYZPNN = this.blockAccess
						.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_ - 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPNN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
						p_147808_3_ - 1, p_147808_4_ - 1);
			}
			...
			if (!flag3 && !flag4) {
				...
				this.aoLightValueScratchXYZPNP = this.blockAccess
						.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPNP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
						p_147808_3_ - 1, p_147808_4_ + 1);
			}
			...
			if (!flag2 && !flag5) {
				...
				this.aoLightValueScratchXYZPPN = this.blockAccess
						.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_ - 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPPN = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
						p_147808_3_ + 1, p_147808_4_ - 1);
			}
			...
			if (!flag2 && !flag4) {
				...
				this.aoLightValueScratchXYZPPP = this.blockAccess
						.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_ + 1).getAmbientOcclusionLightValue();
				this.aoBrightnessXYZPPP = p_147808_1_.getMixedBrightnessForBlock(this.blockAccess, p_147808_2_,
						p_147808_3_ + 1, p_147808_4_ + 1);
			}
	...
	public int mixAoBrightness(int p_147727_1_, int p_147727_2_, int p_147727_3_, int p_147727_4_, double p_147727_5_,
		...
		int i1 = (int) ((double) (p_147727_1_ >> 16 & 255) * p_147727_5_
				+ (double) (p_147727_2_ >> 16 & 255) * p_147727_7_ + (double) (p_147727_3_ >> 16 & 255) * p_147727_9_
				+ (double) (p_147727_4_ >> 16 & 255) * p_147727_11_) & 255;
		int j1 = (int) ((double) (p_147727_1_ & 255) * p_147727_5_ + (double) (p_147727_2_ & 255) * p_147727_7_
	...
	public boolean renderStandardBlockWithColorMultiplier(Block p_147736_1_, int p_147736_2_, int p_147736_3_,
		...
		if (this.renderAllFaces
			...
			tessellator.setBrightness(this.renderMinY > 0.0D ? l
					: p_147736_1_.getMixedBrightnessForBlock(this.blockAccess, p_147736_2_, p_147736_3_ - 1,
							p_147736_4_));
		...
		if (this.renderAllFaces
			...
			tessellator.setBrightness(this.renderMinZ > 0.0D ? l
					: p_147736_1_.getMixedBrightnessForBlock(this.blockAccess, p_147736_2_, p_147736_3_,
							p_147736_4_ - 1));
		...
		if (this.renderAllFaces
			...
			tessellator.setBrightness(this.renderMinX > 0.0D ? l
					: p_147736_1_.getMixedBrightnessForBlock(this.blockAccess, p_147736_2_ - 1, p_147736_3_,
							p_147736_4_));
	...
	public boolean renderBlockCocoa(BlockCocoa p_147772_1_, int p_147772_2_, int p_147772_3_, int p_147772_4_) {
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147772_1_.getMixedBrightnessForBlock(this.blockAccess, p_147772_2_, p_147772_3_, p_147772_4_));
		tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
		int l = this.getMeta(p_147772_2_, p_147772_3_, p_147772_4_);
	...
	public boolean renderBlockCactusImpl(Block p_147754_1_, int p_147754_2_, int p_147754_3_, int p_147754_4_,
		...
		if (this.renderAllFaces
			...
			tessellator.setBrightness(this.renderMinY > 0.0D ? l
					: p_147754_1_.getMixedBrightnessForBlock(this.blockAccess, p_147754_2_, p_147754_3_ - 1,
							p_147754_4_));
	...
	public boolean renderBlockFence(BlockFence p_147735_1_, int p_147735_2_, int p_147735_3_, int p_147735_4_) {
		...
		if (p_147735_1_.canConnectFenceTo(this.blockAccess, p_147735_2_ - 1, p_147735_3_, p_147735_4_)
				|| p_147735_1_.canConnectFenceTo(this.blockAccess, p_147735_2_ + 1, p_147735_3_, p_147735_4_)) {
			flag1 = true;
		}

		if (p_147735_1_.canConnectFenceTo(this.blockAccess, p_147735_2_, p_147735_3_, p_147735_4_ - 1)
				|| p_147735_1_.canConnectFenceTo(this.blockAccess, p_147735_2_, p_147735_3_, p_147735_4_ + 1)) {
			flag2 = true;
		}
	...
	public boolean renderBlockDragonEgg(BlockDragonEgg p_147802_1_, int p_147802_2_, int p_147802_3_, int p_147802_4_) {
		...
		for (int i1 = 0; i1 < 8; ++i1) {
			...
			l += b1;
			this.setRenderBounds((double) (0.5F - f), (double) f2, (double) (0.5F - f), (double) (0.5F + f),
					(double) f1, (double) (0.5F + f));
	...
	public boolean renderBlockFenceGate(BlockFenceGate p_147776_1_, int p_147776_2_, int p_147776_3_, int p_147776_4_) {
		boolean flag = true;
		int l = this.getMeta(p_147776_2_, p_147776_3_, p_147776_4_);
	...
	public boolean renderBlockHopper(BlockHopper p_147803_1_, int p_147803_2_, int p_147803_3_, int p_147803_4_) {
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(
				p_147803_1_.getMixedBrightnessForBlock(this.blockAccess, p_147803_2_, p_147803_3_, p_147803_4_));
		...
		return this.renderBlockHopperMetadata(p_147803_1_, p_147803_2_, p_147803_3_, p_147803_4_,
				this.getMeta(p_147803_2_, p_147803_3_, p_147803_4_), false);
	}
	@Override
	public boolean renderBlockHopperMetadata(BlockHopper p_147799_1_, int p_147799_2_, int p_147799_3_, int p_147799_4_,
		...
		if (!p_147799_6_) {
			tessellator.setBrightness(
					p_147799_1_.getMixedBrightnessForBlock(this.blockAccess, p_147799_2_, p_147799_3_, p_147799_4_));
		...
		if (p_147799_6_) {
			...
			this.renderFaceXPos(p_147799_1_, (double) ((float) p_147799_2_ - 1.0F + f1), (double) p_147799_3_,
					(double) p_147799_4_, iicon);
			this.renderFaceXNeg(p_147799_1_, (double) ((float) p_147799_2_ + 1.0F - f1), (double) p_147799_3_,
					(double) p_147799_4_, iicon);
			this.renderFaceZPos(p_147799_1_, (double) p_147799_2_, (double) p_147799_3_,
					(double) ((float) p_147799_4_ - 1.0F + f1), iicon);
			this.renderFaceZNeg(p_147799_1_, (double) p_147799_2_, (double) p_147799_3_,
					(double) ((float) p_147799_4_ + 1.0F - f1), iicon);
			this.renderFaceYPos(p_147799_1_, (double) p_147799_2_, (double) ((float) p_147799_3_ - 1.0F) + d0,
					(double) p_147799_4_, iicon1);
		}
	...
	public boolean renderBlockDoor(Block p_147760_1_, int p_147760_2_, int p_147760_3_, int p_147760_4_) {
		Tessellator tessellator = Tessellator.instance;
		int l = this.getMeta(p_147760_2_, p_147760_3_, p_147760_4_);
		...
		tessellator.setBrightness(this.renderMinY > 0.0D ? i1
				: p_147760_1_.getMixedBrightnessForBlock(this.blockAccess, p_147760_2_, p_147760_3_ - 1, p_147760_4_));
		tessellator.setColorOpaque_F(f, f, f);
		...
		flag = true;
		tessellator.setBrightness(this.renderMaxY < 1.0D ? i1
				: p_147760_1_.getMixedBrightnessForBlock(this.blockAccess, p_147760_2_, p_147760_3_ + 1, p_147760_4_));
		tessellator.setColorOpaque_F(f1, f1, f1);
		...
		flag = true;
		tessellator.setBrightness(this.renderMinZ > 0.0D ? i1
				: p_147760_1_.getMixedBrightnessForBlock(this.blockAccess, p_147760_2_, p_147760_3_, p_147760_4_ - 1));
		tessellator.setColorOpaque_F(f2, f2, f2);
		...
		flag = true;
		this.flipTexture = false;
		tessellator.setBrightness(this.renderMaxZ < 1.0D ? i1
				: p_147760_1_.getMixedBrightnessForBlock(this.blockAccess, p_147760_2_, p_147760_3_, p_147760_4_ + 1));
		tessellator.setColorOpaque_F(f2, f2, f2);
		...
		flag = true;
		this.flipTexture = false;
		tessellator.setBrightness(this.renderMinX > 0.0D ? i1
				: p_147760_1_.getMixedBrightnessForBlock(this.blockAccess, p_147760_2_ - 1, p_147760_3_, p_147760_4_));
		tessellator.setColorOpaque_F(f3, f3, f3);
		...
		flag = true;
		this.flipTexture = false;
		tessellator.setBrightness(this.renderMaxX < 1.0D ? i1
				: p_147760_1_.getMixedBrightnessForBlock(this.blockAccess, p_147760_2_ + 1, p_147760_3_, p_147760_4_));
		tessellator.setColorOpaque_F(f3, f3, f3);
		...
		if (j != 0 && j != 31 && j != 39 && j != 16 && j != 26) {
			if (j == 1) {
				...
				for (int l = 0; l < 8; ++l) {
					...
					k += b1;
					this.setRenderBounds((double) (0.5F - f5), (double) f7, (double) (0.5F - f5), (double) (0.5F + f5),
							(double) f6, (double) (0.5F + f5));
					tessellator.setNormal(0.0F, -1.0F, 0.0F);
					this.renderFaceYNeg(p_147800_1_, 0.0D, 0.0D, 0.0D, this.getBlockIconFromSide(p_147800_1_, 0));
					tessellator.setNormal(0.0F, 1.0F, 0.0F);
					this.renderFaceYPos(p_147800_1_, 0.0D, 0.0D, 0.0D, this.getBlockIconFromSide(p_147800_1_, 1));
				...
				for (k = 0; k < 4; ++k) {
					...
					if (k == 0) {
						this.setRenderBounds((double) (0.5F - f2), 0.0D, 0.0D, (double) (0.5F + f2), 1.0D,
								(double) (f2 * 2.0F));
					}

					if (k == 1) {
						this.setRenderBounds((double) (0.5F - f2), 0.0D, (double) (1.0F - f2 * 2.0F),
					...
					if (k == 2) {
						this.setRenderBounds((double) (0.5F - f2), (double) (1.0F - f2 * 3.0F), (double) (-f2 * 2.0F),
								(double) (0.5F + f2), (double) (1.0F - f2), (double) (1.0F + f2 * 2.0F));
					}

					if (k == 3) {
						this.setRenderBounds((double) (0.5F - f2), (double) (0.5F - f2 * 3.0F), (double) (-f2 * 2.0F),
								(double) (0.5F + f2), (double) (0.5F - f2), (double) (1.0F + f2 * 2.0F));
					}
				...
				for (k = 0; k < 3; ++k) {
					...
					if (k == 0) {
						this.setRenderBounds((double) (0.5F - f2), 0.30000001192092896D, 0.0D, (double) (0.5F + f2),
								1.0D, (double) (f2 * 2.0F));
					}

					if (k == 1) {
						this.setRenderBounds((double) (0.5F - f2), 0.30000001192092896D, (double) (1.0F - f2 * 2.0F),
								(double) (0.5F + f2), 1.0D, 1.0D);
					}
					...
					if (k == 2) {
						this.setRenderBounds((double) (0.5F - f2), 0.5D, 0.0D, (double) (0.5F + f2),
								(double) (1.0F - f2), 1.0D);
					}
	...
	int getMeta(int x, int y, int z) {
		Integer meta = getMetaTag(new FBPBlockPos(x, y, z));

		return meta == null ? 0 : meta;
	}

	Integer getMetaTag(FBPBlockPos p1) {
		Iterator it = metaTags.keySet().iterator();

		while (it.hasNext()) {
			FBPBlockPos p2 = (FBPBlockPos) it.next();

			if (p1.getX() == p2.getX() && p1.getY() == p2.getY() && p1.getZ() == p2.getZ())
				return metaTags.get(p2);
		}

		return null;
	}

	public void removeMetaTag(FBPBlockPos p1) {
		Iterator it = metaTags.keySet().iterator();
	...
	public void addMetaTag(FBPBlockPos p1, Integer meta) {
		if (getMetaTag(p1) == null)
			metaTags.put(p1, meta);
	}
}