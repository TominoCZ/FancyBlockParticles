...
public class FBPBlockPlaceAnimationDummy extends Particle {
	...
	public FBPBlockPlaceAnimationDummy(World worldIn, double posXIn, double posYIn, double posZIn, IBlockState state,
			long rand) {
