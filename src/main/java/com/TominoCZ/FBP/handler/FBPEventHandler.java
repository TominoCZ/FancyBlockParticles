...
import com.TominoCZ.FBP.particle.FBPBlockPlaceAnimationDummy;
...
public class FBPEventHandler {
	...
	public void onPlayerPlaceBlockEvent(BlockEvent.PlaceEvent e) {
		if (FBP.enabled) {
			...
			mc.effectRenderer.addEffect(new FBPBlockPlaceAnimationDummy(mc.theWorld, pos.getX() + 0.5f, pos.getY() + 0.5f,
