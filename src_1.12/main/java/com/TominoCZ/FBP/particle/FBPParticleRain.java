...
public class FBPParticleRain extends ParticleDigging {
	...
	public void onUpdate() {
		...
		this.particleGreen = (float) rgb.y * 1.5f;
		this.particleBlue = (float) rgb.z * 1.75f;
	...
	public void putCube(BufferBuilder worldRendererIn, double width, double height, double rotX, double rotY, double rotZ, int j,
	...
	private void addVt(BufferBuilder worldRendererIn, double width, double height, Vec3d pos, double u, double v, int j, int k,
