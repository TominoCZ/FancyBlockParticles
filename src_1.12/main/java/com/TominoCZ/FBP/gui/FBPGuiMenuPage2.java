...
public class FBPGuiMenuPage2 extends GuiScreen {
	...
	public void initGui() {
		...
		b2 = new FBPGuiButton(2, x, (int) b1.y + b1.height + 1, b2Text, FBP.cartoonMode, true);

		b3 = new FBPGuiButton(3, x, (int) b2.y + b2.height + 6, b3Text, FBP.smoothTransitions, true);
		b4 = new FBPGuiButton(4, x, (int) b3.y + b3.height + 1, b4Text, FBP.randomFadingSpeed, true);

		b5 = new FBPGuiButton(5, x, (int) b4.y + b4.height + 6, b5Text, FBP.spawnRedstoneBlockParticles, true);
		b6 = new FBPGuiButton(6, x, (int) b5.y + b5.height + 1, b6Text, FBP.spawnWhileFrozen, true);

		Back = new FBPGuiButton(-3, b6.x - (20 + 3 + 2 + 19)/* this.width / 2 - 125 */, (int) b6.y + 10, "<<",
				false, false);
		Next = new FBPGuiButton(-5, b6.x + b6.width + 3 + 2 + 20, (int) b6.y + 10, ">>", false, false);

		Defaults = new FBPGuiButton(0, this.width / 2 + 2, b6.y + b6.height + 24, "Defaults", false, false);
		Done = new FBPGuiButton(-1, this.width / 2 - 100, (int) Defaults.y, "Done", false, false);
		Reload = new FBPGuiButton(-2, this.width / 2 - 100, (int) Defaults.y + Defaults.height + 1, "Reload Config",
				false, false);
