...
public class FBPGuiMenuPage3 extends GuiScreen {
	...
	public void initGui() {
		...
		Back = new FBPGuiButton(-3, b6.xPosition - 44, 6 * b1.height + b1.yPosition - 5 + 10 - GUIOffsetY, "<<",
				false, false);
		Next = new FBPGuiButton(-6, b6.xPosition + b6.width + 25, b6.yPosition + 10 - GUIOffsetY, ">>", false,
				false);
		...
		Reload = new FBPGuiButton(-2, Done.xPosition, Defaults.yPosition + Defaults.height + 1, "Reload Config",
				false, false);
