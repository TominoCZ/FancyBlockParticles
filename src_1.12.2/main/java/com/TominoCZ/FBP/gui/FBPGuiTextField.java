...
public class FBPGuiTextField extends Gui {
	...
	public FBPGuiTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
		this.id = componentId;
	...
	public boolean mouseClicked(int mouseX, int mouseY, int mouseButton) {
		boolean flag = mouseX >= this.x && mouseX < this.x + this.width && mouseY >= this.y
	...
	public void drawTextBox() {
		if (this.getVisible()) {
			...
			// j1 = this.fontRenderer.drawStringWithShadow(s1, (float) j1, (float) i1, i);
			// }
