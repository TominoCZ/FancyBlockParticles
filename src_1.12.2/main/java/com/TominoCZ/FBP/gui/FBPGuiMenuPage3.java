...
public class FBPGuiMenuPage3 extends GuiScreen {
	...
	public void initGui() {
		...
		b3 = new FBPGuiButton(3, x, b2.y + b1.height + 6, b3Text, FBP.rollParticles, true);
		...
		b6 = new FBPGuiButton(6, x, b5.y + b1.height + 1, b6Text, FBP.fancyWeather, true);

		b5_settings = new FBPGuiButton(7, x + b1.width + 5, b5.y, "cogwheel", false, false);

		Back = new FBPGuiButton(-3, b6.x - (20 + 3 + 2 + 19), (int) 6 * b1.height + b1.y - 5 + 10, "<<", false, false);
		Next = new FBPGuiButton(-6, b6.x + b6.width + 3 + 2 + 20, (int) b6.y + 10, ">>", false, false);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if ((mouseX >= b1.x && mouseX < b1.x + b1.width)
				&& (mouseY >= b1.y && mouseY < b6.y + b1.height) || b5_settings.isMouseOver()) {
