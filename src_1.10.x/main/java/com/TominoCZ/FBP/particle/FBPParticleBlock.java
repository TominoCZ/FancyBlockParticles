...
public class FBPParticleBlock extends Particle
{
			...
			float rotationYZ, float rotationXY, float rotationXZ)
	{
		...
		if (FBP.animSmoothLighting)
			mr.renderModelSmooth(mc.theWorld, modelPrefab, blockState, pos, buff, false, textureSeed);
		else
			mr.renderModelFlat(mc.theWorld, modelPrefab, blockState, pos, buff, false, textureSeed);
	...
	private void spawnParticles()
	{
		...
		for (Vector2d corner : corners)
		{
			...
			mc.effectRenderer.addEffect(
					new FBPParticleDigging(mc.theWorld, corner.x, pos.getY() + 0.1f, corner.y, mX, 0, mZ, 0.6f, 1, 1, 1,
							block.getActualState(blockState, mc.theWorld, pos), null, this.particleTexture)
		...
		for (Vector2d corner : corners)
		{
			...
			mc.effectRenderer.addEffect(
					new FBPParticleDigging(mc.theWorld, corner.x, pos.getY() + 0.1f, corner.y, mX / 3, 0, mZ / 3, 0.6f,
							1, 1, 1, block.getActualState(blockState, mc.theWorld, pos), null, this.particleTexture)
